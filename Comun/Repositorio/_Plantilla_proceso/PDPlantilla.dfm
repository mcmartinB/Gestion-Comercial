object DPPlantilla: TDPPlantilla
  ...
  object QProceso: TQuery
    ...
    Left = 32
    Top = 40
    object QProcesoempresa: TStringField
      FieldName = 'empresa'
      FixedChar = True
      Size = 3
    end
    object QProcesocentro: TStringField
      FieldName = 'centro'
      FixedChar = True
      Size = 1
    end
    object QProcesocliente: TStringField
      FieldName = 'cliente'
      FixedChar = True
      Size = 3
    end
    object QProcesofecha: TDateField
      FieldName = 'fecha'
    end
    object QProcesoalbaran: TIntegerField
      FieldName = 'albaran'
    end
    object QProcesoproducto: TStringField
      FieldName = 'producto'
      FixedChar = True
      Size = 1
    end
    object QProcesoenvase: TStringField
      FieldName = 'envase'
      FixedChar = True
      Size = 3
    end
    object QProcesomoneda: TStringField
      FieldName = 'moneda'
      FixedChar = True
      Size = 3
    end
    object QProcesokilos: TFloatField
      FieldName = 'kilos'
    end
    object QProcesocajas: TFloatField
      FieldName = 'cajas'
    end
    object QProcesoimporte: TFloatField
      FieldName = 'importe'
    end
  end
end
