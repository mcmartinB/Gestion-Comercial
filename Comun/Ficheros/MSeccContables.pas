...
begin
 ...
 {+}Select := ' SELECT * FROM frf_secciones_contables ';
 {+}where := ' WHERE empresa_sc="###"';
 {+}Order := ' ORDER BY empresa_sc, seccion_sc ';
     //Abrir tablas/Querys
  try
    AbrirTablas;
...
begin
  ...
  begin
    ...
    begin
      SQL.Clear;
      SQL.Add('select centro_esc, envase_e, linea_producto_e, descripcion_e, fecha_baja_e ');
      SQL.Add('from frf_envases, frf_env_sec_contables ');
...
begin
  ...
  case TComponent(Sender).Tag of
    kEmpresa:
    begin
      STEmpresa.Caption := desEmpresa(empresa_sc.Text);
    end;
  end;
end;
