object FDImportarTransportista: TFDImportarTransportista
  Left = 601
  Top = 269
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'IMPORTAR TRANSPORTISTA BD REMOTA'
  ClientHeight = 323
  ClientWidth = 669
  Color = clBtnFace
  ...
  object lblNombre7: TLabel
    ...
    Height = 17
    AutoSize = False
    Caption = ' C'#243'digo Transportista'
    Color = cl3DLight
    ParentColor = False
    Layout = tlCenter
  end
  ...
  object btnImportar: TButton
    ...
    Width = 129
    Height = 25
    Caption = 'Importar Transportista'
    TabOrder = 1
  ...
  object txtTransportista: TStaticText
    Left = 173
    Top = 49
    Width = 251
    Height = 17
  ...
  object qryTransportista: TQuery
  ...
  object dsTransportista: TDataSource
    DataSet = qryTransportista
    Left = 314
    Top = 177
  end
end
