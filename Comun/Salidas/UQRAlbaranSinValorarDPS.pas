...
type
  TQRAlbaranSinValorarDPS = class(TQuickRep)
    BonnyBand: TQRBand;
    bandaFinal: TQRBand;
    BandaDatos: TQRBand;
    ...
    procedure LGGNPrint(sender: TObject; var Value: string);
...
constructor TQRAlbaranSinValorarDPS.Create(AOwner: TComponent);
begin
  inherited;
...
destructor TQRAlbaranSinValorarDPS.Destroy;
begin
...
procedure TQRAlbaranSinValorarDPS.GetCodigoProveedor(const AEmpresa, ACliente: string);
begin
...
procedure TQRAlbaranSinValorarDPS.GetResumen(const AEmpresa, ACentro, AAlbaran, Afecha: string);
var
...
procedure TQRAlbaranSinValorarDPS.QuickReport1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
...
procedure TQRAlbaranSinValorarDPS.BandaDatosBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
(*
var
  temporal: string;
...
procedure TQRAlbaranSinValorarDPS.Configurar(const AEmpresa: string);
var
  bAux: Boolean;
...
procedure TQRAlbaranSinValorarDPS.QRSubDetail1NeedData(Sender: TObject;
...
procedure TQRAlbaranSinValorarDPS.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TQRAlbaranSinValorarDPS.PsQRLabel19Print(sender: TObject;
  var Value: string);
begin
...
procedure TQRAlbaranSinValorarDPS.bandaFinalBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  ...
  begin
      if bEnEspanyol = true then
        memoGarantia.Lines.Add(rggn.descri_esp+rggn.ggn_code)
      else
...
procedure TQRAlbaranSinValorarDPS.ChildBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if bOriginal then
  begin
...
procedure TQRAlbaranSinValorarDPS.CabeceraTablaBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TQRAlbaranSinValorarDPS.ChildBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  PrintBand := mmoObservaciones.Lines.Count <> 0;
end;

procedure TQRAlbaranSinValorarDPS.LPaletsPrint(sender: TObject; var Value: string);
begin
  if MemoPalets.Lines.Count = 0 then Value := '';
end;

procedure TQRAlbaranSinValorarDPS.LCajasPrint(sender: TObject; var Value: string);
begin
  if MemoCajas.Lines.Count = 0 then Value := '';
end;

procedure TQRAlbaranSinValorarDPS.LGGNPrint(sender: TObject; var Value: string);
begin
  Value := self.GGN_Code;
end;

procedure TQRAlbaranSinValorarDPS.ChildBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TQRAlbaranSinValorarDPS.bndPaletsMercadonaBeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  PrintBand:= ( empresa = '037' ) and  ( cliente = 'MER' ) and ( tag = 2 );
end;

procedure TQRAlbaranSinValorarDPS.descripcion2_ePrint(sender: TObject;
  var Value: string);
...
procedure TQRAlbaranSinValorarDPS.PsQRLabel8Print(sender: TObject;
  var Value: String);
begin
(*
  if cliente = 'MER' then
...
procedure TQRAlbaranSinValorarDPS.psKilosPrint(sender: TObject;
  var Value: String);
begin
  if cliente = 'MER' then
  begin
...
procedure TQRAlbaranSinValorarDPS.cajasPrint(sender: TObject; var Value: String);
begin
  //CAJAS O UNIDADES
  if cliente = 'MER' then
  begin
...
procedure TQRAlbaranSinValorarDPS.PsQRLabel18Print(sender: TObject;
  var Value: String);
begin
  if cliente = 'MER' then
  begin
...
procedure TQRAlbaranSinValorarDPS.PsQRLabel27Print(sender: TObject;
  var Value: String);
begin
  if cliente = 'MER' then
  begin
...
procedure TQRAlbaranSinValorarDPS.PsQRLabel28Print(sender: TObject;
  var Value: String);
begin
  if cliente = 'MER' then
  begin
...
procedure TQRAlbaranSinValorarDPS.QRDBText1Print(sender: TObject; var Value: String);
begin
  if cliente = 'MER' then
  begin
...
procedure TQRAlbaranSinValorarDPS.UnidadCobroPrint(sender: TObject;
  var Value: String);
begin
  Value:= Copy( Value, 1, 1 );
end;

procedure TQRAlbaranSinValorarDPS.QRDBText2Print(sender: TObject; var Value: String);
begin
  //CAJAS O UNIDADES
  if cliente = 'MER' then
  begin
...
procedure TQRAlbaranSinValorarDPS.QRDBText3Print(sender: TObject;
  var Value: string);
begin
  Value := desVariedadCliente(DMBaseDatos.QListado.FieldByName('envase_e').AsString, cliente);
end;

procedure TQRAlbaranSinValorarDPS.qrlLblIvaPrint(sender: TObject; var Value: String);
begin
...
procedure TQRAlbaranSinValorarDPS.PsQRLabel25Print(sender: TObject;
  var Value: String);
begin
  if empresa = '001' then
  begin
...
procedure TQRAlbaranSinValorarDPS.colorPrint(sender: TObject; var Value: String);
begin
  if empresa = '001' then
    Value:= DMBaseDatos.QListado.FieldByName('categoria_sl').AsString;
end;

procedure TQRAlbaranSinValorarDPS.LVehiculoPrint(sender: TObject; var Value: String);
begin
  //PARA BORRAR
end;

procedure TQRAlbaranSinValorarDPS.productoPrint(sender: TObject; var Value: String);
begin
