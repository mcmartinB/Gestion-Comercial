...
begin
  try
    ...
    MessageDlg('' + #13 + #10 + 'No se puede generar el informe.' + #13 + #10 + '' + #13 + #10 + 'Error al intentar seleccionar datos para la     ' + #13 + #10 + 'generación de los albaranes.', mtError, [mbOK], 0);
    PrintReport := False;
    Exit;
  end;
...
begin
  ...
  begin
    psMemoCalidad.Lines.Text := 'Toda la producción de tomate comercializada por ' +
      'S.A.T. Nº9359 BONNYSA está certificada conforme a ' +
      'las normas UNE 155001-1 (1997) y UNE 155001-2.';
  end
  else
  begin
    psMemoCalidad.Lines.Text := 'All the tomatoes packed by S.A.T Nº9359 BONNYSA are ' +
