object QLFacturasGastosTransporte: TQLFacturasGastosTransporte
  Left = 0
  Top = 0
  Width = 1123
  Height = 794
  ...
  DataSet = FLFacturasGastosSalidas.kbmTablaTemporal
  ...
  object bndEmpresa: TQRBand
    ...
    Frame.DrawRight = False
    AlignToBottom = False
    BeforePrint = bndEmpresaBeforePrint
    Color = clWhite
    TransparentBand = False
    ForceNewColumn = False
    ForceNewPage = False
  ...
  object grpTransporte: TQRGroup
    ...
    PreCaluculateBandHeight = False
    KeepOnOnePage = False
    Expression = '[empresa] + [transporte_g]'
  ...
  object grpTipo: TQRGroup
    ...
    PreCaluculateBandHeight = False
    KeepOnOnePage = False
    Expression = '[empresa] + [transporte_g] + [agrupacion]+[tipo]'
    Master = Owner
    ReprintOnNewPage = False
  ...
  object grpFactura: TQRGroup
    ...
    KeepOnOnePage = False
    Expression = 
      '[empresa] + [transporte_g] + [agrupacion]+[tipo]+[fecha]+[factur' +
      'a]'
