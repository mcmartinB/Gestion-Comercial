...
//        qrmGarantia.Lines.Add(trim(rGGN.arterisco+ 'Toda la producción hortofrutícola comercializada por S.A.T. Nº9359 BONNYSA está certificada conforme a la norma GLOBALGAP IFA V5.3.    GGN='+rGGN.ggn_code))
//      else
//        qrmGarantia.Lines.Add(trim(rGGN.arterisco+ 'All the fruit and vegatables produts packed by S.A.T. Nº9359 BONNYSA are certified according to GLOBALGAP IFA V5.3 product standards.     GGN='+rGGN.ggn_code));
//      end;
    end;
    PsQRLabel1.Top:= 62;
    PsQRLabel2.Top:= 62;
...
begin
  ...
  try
    ...
    begin
      QRAlbaranInglesVal.mmoObservaciones.Lines.Add('Nº ORDEN CARGA:' + DMBaseDatos.QListado.FieldByName('n_orden_sc').AsString );
    end;
