unit UQRAlbaranExportacionIngles;
...
type
  TQRAlbaranExportacionIngles = class(TQuickRep)
    BonnyBand: TQRBand;
    BandaDatos: TQRBand;
...
constructor TQRAlbaranExportacionIngles.Create(AOwner: TComponent);
begin
  inherited;
...
destructor TQRAlbaranExportacionIngles.Destroy;
begin
  resumenList.Free;
...
procedure TQRAlbaranExportacionIngles.QuickReport1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  bHayGranada:= False;
  bEnEspanyol:= False;
...
procedure TQRAlbaranExportacionIngles.BandaDatosBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TQRAlbaranExportacionIngles.Configurar(const AEmpresa: string);
var
  bAux: Boolean;
  sAux: string;
  ssEmpresa: string;
...
procedure TQRAlbaranExportacionIngles.PsQRLabel19Print(sender: TObject;
  var Value: string);
begin
...
procedure TQRAlbaranExportacionIngles.ChildBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  PrintBand := mmoObservaciones.Lines.Count <> 0;
end;

procedure TQRAlbaranExportacionIngles.ChildBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if bEnEspanyol then
  begin
...
procedure TQRAlbaranExportacionIngles.cajasPrint(sender: TObject; var Value: String);
begin
  value := FormatFloat('#,##0', DataSet.FieldByName('cajas_sl').AsInteger);
end;

procedure TQRAlbaranExportacionIngles.unidadesPrint(sender: TObject;
  var Value: String);
begin
...
procedure TQRAlbaranExportacionIngles.unidad_cajaPrint(sender: TObject;
  var Value: String);
begin
  if DataSet.FieldByName('unidades_sl').AsInteger <>
     DataSet.FieldByName('cajas_sl').AsInteger then
...
procedure TQRAlbaranExportacionIngles.qrlbl3Print(sender: TObject;
  var Value: String);
begin
  if iUnidades <> 0 then
  begin
...
procedure TQRAlbaranExportacionIngles.categoriaPrint(sender: TObject;
  var Value: String);
begin
  Value:= desCategoria( sempresa, DataSet.FieldByName('producto_sl').AsString, Value  )
end;

procedure TQRAlbaranExportacionIngles.qrdbtxtdescripcion_p1Print(sender: TObject; var Value: string);
begin
...
procedure TQRAlbaranExportacionIngles.qrdbtxtdescripcion_pPrint(sender: TObject;
  var Value: String);
begin
  if bMultiproductoLin then
  begin
...
procedure TQRAlbaranExportacionIngles.qrdbtxtenvase_slPrint(sender: TObject;
  var Value: string);
...
procedure TQRAlbaranExportacionIngles.FontLinea( const ATipo: Integer );
begin
  case ATipo of
    0:
    begin
...
procedure TQRAlbaranExportacionIngles.brutoPrint(sender: TObject;
  var Value: String);
var
  rAux: Real;
begin
...
procedure TQRAlbaranExportacionIngles.qrlbl10Print(sender: TObject;
  var Value: String);
begin
...
procedure TQRAlbaranExportacionIngles.paletsPrint(sender: TObject;
  var Value: String);
begin
  value := FormatFloat('#,##0', DataSet.FieldByName('palets_sl').AsInteger );
end;

procedure TQRAlbaranExportacionIngles.qrgrp1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TQRAlbaranExportacionIngles.qrchldbndChildBand4BeforePrint(
