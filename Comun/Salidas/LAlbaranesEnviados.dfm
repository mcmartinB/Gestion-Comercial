object QRLAlbaranesEnviados: TQRLAlbaranesEnviados
  Left = 0
  Top = 0
  Width = 794
  Height = 1123
  ...
  DataSet = FLAlbaranesEnviados.QAlbaranesEnviados
  ...
  PrintIfEmpty = True
  ReportTitle = 'Listado de Albaranes Enviados por Correo Electr'#243'nico'
  SnapToGrid = True
  Units = MM
  Zoom = 100
