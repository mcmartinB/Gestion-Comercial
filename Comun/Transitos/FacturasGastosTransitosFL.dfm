object FLFacturasGastosTransitos: TFLFacturasGastosTransitos
  Left = 316
  Top = 414
  ActiveControl = eEmpresa
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = ' LISTADO FACTURAS TR'#193'NSITOS'
  ClientHeight = 337
  ClientWidth = 499
  Color = clBtnFace
  ...
  object qryQLCompGastosCompras: TQuery
  ...
  object kbmTablaTemporal: TkbmMemTable
    ...
    object kbmTablaTemporaltransporte_gt: TSmallintField
      FieldName = 'transporte_gt'
    end
