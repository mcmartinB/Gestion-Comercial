object QRLiqProdVendidoPlan: TQRLiqProdVendidoPlan
  Left = 0
  Top = 0
  Width = 1123
  Height = 794
  ...
  object qrgrpPlantacion: TQRGroup
    ...
    object qtxtplantacion: TQRDBText
      ...
      Color = clWhite
      DataSet = DMLiqProdVendido.qryReportPlanta
      DataField = 'plantacion_ent'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -9
      Font.Name = 'Arial'
      Font.Style = [fsBold]
      OnPrint = qtxtplantacionPrint
      ParentFont = False
      Transparent = True
      WordWrap = True
      FontSize = 7
    ...
    object qtxtSemana_planta1: TQRDBText
      ...
      Font.Name = 'Arial'
      Font.Style = [fsBold]
      OnPrint = qtxtSemana_planta1Print
      ParentFont = False
      Transparent = True
      WordWrap = True
      FontSize = 7
  ...
  object qrbnd1: TQRBand
    ...
    object qrxpr26: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(IF([facturado]=1,0,[liquido_liq]))'
      Mask = '#,##0.00'
      FontSize = 7
    end
    object qrxpr27: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(IF([facturado]=1,0,[costes_financiero_liq]))'
      Mask = '#,##0.00'
      FontSize = 7
    end
    object qrxpr28: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(IF([facturado]=1,0,[costes_abonos_liq]))'
      Mask = '#,##0.00'
      FontSize = 7
    end
    object qrxpr29: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(IF([facturado]=1,0,[costes_sec_transito_liq]))'
      FontSize = 7
    end
    object qrxpr30: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(IF([facturado]=1,0,[costes_envasado_liq]))'
      FontSize = 7
    end
    object qrxpr31: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(IF([facturado]=1,0,[gastos_transito_liq]))'
      Mask = '#,##0.00'
      FontSize = 7
    end
    object qrxpr32: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(IF([facturado]=1,0,[gastos_nofac_liq]))'
      Mask = '#,##0.00'
      FontSize = 7
    end
    object qrxpr33: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(IF([facturado]=1,0,[descuentos_nofac_liq]))'
      Mask = '#,##0.00'
      FontSize = 7
    end
    object qrxpr34: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(IF([facturado]=1,0,[gastos_fac_liq]+[descuentos_fac_liq]))'
      Mask = '#,##0.00'
      FontSize = 7
    end
    object qrxpr35: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(IF( [facturado]=1,0,[importe_liq]))'
      Mask = '#,##0.00'
      FontSize = 7
    end
    object qrxpr36: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'SUM(IF(facturado = 1,0,kilos_liq))'
      Mask = '#,##0'
      FontSize = 7
    end
    object qrxpr37: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'SUM(IF([facturado] = 1,0,[kilos_ent]))'
      Mask = '#,##0'
      FontSize = 7
    end
  end
  object qrgrpFacturadoCab: TQRGroup
    ...
    Expression = 
      '[empresa_ent] + [producto_ent] + [centro_ent] + [cosechero_ent] ' +
      ' + [centro_origen_ent]+[plantacion_ent] + [semana_planta_ent]+[f' +
      'acturado]'
  ...
  object qrbndPiePlantacion: TQRBand
    ...
    object qtxtplantacion_ent1: TQRDBText
      Left = 33
      Top = 3
      Width = 183
      Height = 14
