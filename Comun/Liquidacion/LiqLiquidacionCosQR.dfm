object QRLiqLiquidacionCos: TQRLiqLiquidacionCos
  Left = 0
  Top = 0
  Width = 794
  Height = 1123
  ...
  DataSet = DMLiqLiquidacionCos.kmtLiqCos
  ...
  object qrbndBandaDetalle: TQRBand
    ...
    object qrxpr4: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'IF([kilos_liq_comer]>0,[kilos_fac_comer]/[kilos_liq_comer],0)'
      Mask = '#,##0.00'
      FontSize = 7
    end
  ...
  object qrbnd1: TQRBand
    ...
    object qrxpr15: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum([kilos_liq_comer])'
      Mask = '#,##0'
      FontSize = 7
    end
    object qrxpr16: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum([kilos_fac_comer])'
      Mask = '#,##0.00'
      FontSize = 7
    end
