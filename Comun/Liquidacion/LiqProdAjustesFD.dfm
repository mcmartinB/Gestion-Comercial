object FDLiqProdAjustes: TFDLiqProdAjustes
  Left = 454
  Top = 225
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = '    PROCESO CALCULO MERMA Y AJUSTE A LAS SALIDAS'
  ClientHeight = 267
  ClientWidth = 520
  Color = clBtnFace
  ...
  object SpeedButton1: TSpeedButton
    ...
    Height = 28
    Action = BAceptar
    Caption = 'Calcular merma y ajustar a las salidas'
    Glyph.Data = {
