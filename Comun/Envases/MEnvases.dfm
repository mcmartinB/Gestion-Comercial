object FMEnvases: TFMEnvases
  ...
  object PMaestro: TPanel
    ...
    object des_producto_e: TStaticText
      Left = 601
      Top = 31
      Width = 161
      Height = 17
    ...
    object pEnvasOld: TPanel
      ...
      object empresaold_e: TBDEdit
        ...
        MaxLength = 3
        TabOrder = 0
        DataField = 'empresaold_e'
        DataSource = DSMaestro
        Modificable = False
      end
      object envaseold_e: TBDEdit
        Left = 188
        Top = 11
        Width = 39
        Height = 21
        ...
        MaxLength = 3
        TabOrder = 1
        DataField = 'envaseold_e'
        DataSource = DSMaestro
        Modificable = False
      end
    end
    object notas_e: TcxDBMemo
      Left = 152
      Top = 169
      DataBinding.DataField = 'notas_e'
      ...
      object DBGrid1: TDBGrid
        ...
        Columns = <
          ...
          item
            ...
            FieldName = 'oldenvase'
            Title.Alignment = taCenter
            Title.Caption = 'ANTIGUO ENVASE'
            Width = 110
            Visible = True
          end>
      end
    end
    object tsDesglose: TTabSheet
      Caption = 'Desglose Producto'
      ImageIndex = 5
  ...
  object dsDesglose: TDataSource
    DataSet = QDesglose
    OnDataChange = DSMaestroDataChange
    Left = 736
    Top = 560
  end
  object QDesglose: TQuery
    DatabaseName = 'BDProyecto'
    DataSource = DSMaestro
    SQL.Strings = (
      'SELECT * FROM frf_articulos_desglose'
      'ORDER BY articulo_ad, producto_desglose_ad ')
    Left = 704
    Top = 560
  end
end
