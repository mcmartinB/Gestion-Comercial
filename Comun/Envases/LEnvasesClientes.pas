...
type
  TQRLEnvasesClientes = class(TQuickRep)
    DetailBand1: TQRBand;
...
var
  QRLEnvasesClientes: TQRLEnvasesClientes;
...
procedure TQRLEnvasesClientes.QRSysData1Print(sender: TObject; var Value: string);
begin
  if Tag > 0 then
    Value := Value + ' de ' + IntToStr(Tag);
end;

procedure TQRLEnvasesClientes.PsQRDBText2Print(sender: TObject; var Value: string);
begin
  if Value = '0,000' then Value := '';
end;

procedure TQRLEnvasesClientes.producto_ePrint(sender: TObject;
  var Value: String);
begin
  if Trim( Value ) = '' then
...
procedure TQRLEnvasesClientes.QRDBText2Print(sender: TObject; var Value: String);
begin
  Value:= desTipoUnidad( DataSet.fieldByName('empresa_e').AsString, Value,
                         DataSet.fieldByName('producto_e').AsString );
end;

procedure TQRLEnvasesClientes.notas_ePrint(sender: TObject; var Value: String);
begin
  Value:= Trim( Value );
end;

procedure TQRLEnvasesClientes.empresa_ePrint(sender: TObject; var Value: String);
begin
  Value:= Value + ' - ' + desEmpresa( Value );
end;

procedure TQRLEnvasesClientes.cod_almacen_ePrint(sender: TObject;
  var Value: String);
begin
  If Value = 'S' then
    Value:= 'SI'
...
procedure TQRLEnvasesClientes.QRDBText4Print(sender: TObject; var Value: String);
begin
  Value:= Value + ' Kgs';
end;

procedure TQRLEnvasesClientes.peso_variable_ePrint(sender: TObject; var Value: String);
begin
...
procedure TQRLEnvasesClientes.envase_comercial_ePrint(sender: TObject;
  var Value: String);
begin
...
procedure TQRLEnvasesClientes.unidad_fac_cePrint(sender: TObject;
  var Value: String);
begin
  if value = 'K' then
...
procedure TQRLEnvasesClientes.n_palets_cePrint(sender: TObject; var Value: String);
begin
  Value:= 'Caj palet: ' + Value;
end;

procedure TQRLEnvasesClientes.kgs_palet_cePrint(sender: TObject;
  var Value: String);
begin
  Value:= 'Kgs palet: ' + Value;
end;

procedure TQRLEnvasesClientes.fecha_baja_ePrint(sender: TObject;
  var Value: String);
begin
...
procedure TQRLEnvasesClientes.descripcion_cePrint(sender: TObject;
  var Value: String);
begin
...
procedure TQRLEnvasesClientes.qrecliente_cePrint(sender: TObject;
  var Value: String);
begin
  Value:= desCliente( Value );
end;

procedure TQRLEnvasesClientes.tipo_iva_ePrint(sender: TObject; var Value: String);
begin
  if Value = '0' then
    Value:= '0 Super'
  else
...
procedure TQRLEnvasesClientes.texto_caja_ePrint(sender: TObject;
  var Value: String);
begin
  Value:= desEnvComerProducto( DataSet.FieldbyName('env_comer_operador_e').AsString, Value );
end;

procedure TQRLEnvasesClientes.tipo_caja_ePrint(sender: TObject; var Value: String);
begin
