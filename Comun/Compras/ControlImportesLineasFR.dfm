object FRControlImportesLineas: TFRControlImportesLineas
  Left = 288
  Top = 239
  ActiveControl = edtAnyoSemana
  BorderIcons = []
  ...
  object des_almacen: TnbStaticText
    Left = 177
    Top = 127
    Width = 190
    Height = 21
  ...
  object edtMaxDiferencia: TBEdit
    Left = 228
    Top = 206
    Width = 44
    Height = 21
  ...
  object cbbVer: TComboBox
    ...
    Items.Strings = (
      'Todas las entregas'
      'Con diferencia mayor que '
      'Con diferencia menor que ')
  end
  ...
  object CalendarioFlotante: TBCalendario
    ...
    Width = 177
    Height = 140
    Date = 36717.671907106480000000
    ShowToday = False
    TabOrder = 0
    Visible = False
    WeekNumbers = True
  end
  object chkVerAlmacen: TCheckBox
    Left = 43
    Top = 230
    Width = 97
    Height = 17
    Caption = 'Ver Almac'#233'n'
    TabOrder = 12
  end
