object FLComprobacionGastosEntregas: TFLComprobacionGastosEntregas
  Left = 362
  Top = 175
  ActiveControl = eEmpresa
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = ' COMPROBACI'#211'N GASTOS COMPRAS'
  ClientHeight = 441
  ClientWidth = 347
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object lblNombre1: TLabel
      ...
      Width = 252
      Height = 13
      Caption = 'Seleccione los tipos de gastos que quiera comprobar:'
    end
