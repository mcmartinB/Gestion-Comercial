object QLLiquidaValorarPalets: TQLLiquidaValorarPalets
  Left = 0
  Top = 0
  Width = 1123
  Height = 794
  ...
  DataSet = DLLiquidaEntrega.kmtPalet
  ...
  object BandaDetalle: TQRBand
    ...
    object qrdbtxtpal_cajas_confeccionados: TQRDBText
      ...
      Color = clWhite
      DataSet = DLLiquidaEntrega.kmtPalet
      DataField = 'pal_cajas_confeccionados'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Arial'
    ...
    object qrdbtxtpal_importe_descuento: TQRDBText
      ...
      Color = clWhite
      DataSet = DLLiquidaEntrega.kmtPalet
      DataField = 'pal_importe_descuento'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Arial'
    ...
    object qrdbtxtpal_importe_material: TQRDBText
      ...
      Color = clWhite
      DataSet = DLLiquidaEntrega.kmtPalet
      DataField = 'pal_importe_envasado'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Arial'
    ...
    object qrdbtxtpal_albaran_sal: TQRDBText
      ...
      Color = clWhite
      DataSet = DLLiquidaEntrega.kmtPalet
      DataField = 'pal_sscc_origen'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Arial'
      Font.Style = []
      OnPrint = qrdbtxtpal_albaran_salPrint
      ParentFont = False
      Transparent = False
      WordWrap = True
      FontSize = 8
    ...
    object qrdbtxtpal_kilos_liquidar: TQRDBText
      ...
      Color = clWhite
      DataSet = DLLiquidaEntrega.kmtPalet
      DataField = 'pal_kilos_confeccionados'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Arial'
    ...
    object qrdbtxtpal_entrega5: TQRDBText
      ...
      Color = clWhite
      DataSet = DLLiquidaEntrega.kmtPalet
      DataField = 'pal_entrega'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Arial'
      Font.Style = []
      OnPrint = qrdbtxtpal_entrega5Print
      ParentFont = False
      Transparent = False
      WordWrap = True
      FontSize = 8
  ...
  object SummaryBand1: TQRBand
    ...
    object qrxpr1: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(pal_cajas_confeccionados)'
      Mask = '#,##0.00'
      FontSize = 8
    end
    object qrxpr2: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(pal_kilos_teoricos)'
      Mask = '#,##0.00'
      FontSize = 8
    end
    object qrxpr3: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(pal_importe_descuento)'
      Mask = '#,##0.00'
      FontSize = 8
    end
    object qrxpr4: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(pal_importe_neto)'
      Mask = '#,##0.00'
      FontSize = 8
    end
    object qrxpr5: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(pal_importe_gastos)'
      Mask = '#,##0.00'
      FontSize = 8
    end
    object qrxpr6: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(pal_importe_compra)'
      Mask = '#,##0.00'
      FontSize = 8
    end
    object qrxpr7: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(pal_importe_envasado)'
      Mask = '#,##0.00'
      FontSize = 8
    end
    object qrxpr18: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(pal_kilos_confeccionados)'
      Mask = '#,##0.00'
      FontSize = 8
    end
    object qrxpr19: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(pal_kilos_liquidar)'
      Mask = '#,##0.00'
      FontSize = 8
    end
  end
  object qrgrpEntrega: TQRGroup
    ...
    PreCaluculateBandHeight = False
    KeepOnOnePage = False
    Expression = '[pal_anyo_semana]+[pal_proveedor]+[pal_almacen]+[pal_entrega]'
    ...
    object qrdbtxt1: TQRDBText
      ...
      Color = clWhite
      DataSet = DLLiquidaEntrega.kmtPalet
      DataField = 'pal_proveedor'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Arial'
      Font.Style = [fsBold]
      OnPrint = qrdbtxtpal_proveedor1Print
      ParentFont = False
      Transparent = False
      WordWrap = True
      FontSize = 8
  ...
  object qrbndPieEntrega: TQRBand
    ...
    object qrdbtxtpal_entrega1: TQRDBText
      Left = 46
      Top = 2
      Width = 88
      Height = 15
    ...
    object qrdbtxtpal_entrega2: TQRDBText
      Left = 510
      Top = 16
      Width = 55
      Height = 15
    ...
    object qrdbtxtpal_entrega3: TQRDBText
      Left = 566
      Top = 16
      Width = 60
      Height = 15
    ...
    object qrdbtxtpal_entrega4: TQRDBText
      Left = 449
      Top = 16
      Width = 59
      Height = 15
    ...
    object qrdbtxtpal_proveedor1: TQRDBText
      Left = 179
      Top = 2
      Width = 270
      Height = 15
    ...
    object qrxpr30: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(pal_kilos_confeccionados/1.04)'
      Mask = '#,##0.00'
      FontSize = 8
    end
  ...
  object qrgrpCategoria: TQRGroup
    ...
    Frame.DrawRight = False
    AlignToBottom = False
    BeforePrint = qrgrpCategoriaBeforePrint
    Color = clWhite
    TransparentBand = False
    ForceNewColumn = False
    ForceNewPage = False
    ...
    KeepOnOnePage = False
    Expression = 
      '[pal_anyo_semana]+[pal_proveedor]+[pal_almacen]+[pal_entrega]+[p' +
      'al_categoria]'
  ...
  object qrbndPieCategoria: TQRBand
    ...
    object qrdbtxtpal_categoria1: TQRDBText
      Left = 328
      Top = 2
      Width = 119
      Height = 15
      ...
      Font.Name = 'Arial'
      Font.Style = [fsBold]
      OnPrint = qrdbtxtpal_categoria1Print
      ParentFont = False
      Transparent = False
      WordWrap = True
      FontSize = 8
