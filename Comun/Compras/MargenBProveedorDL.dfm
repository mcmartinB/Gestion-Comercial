object DLMargenBProveedor: TDLMargenBProveedor
  OldCreateOrder = False
  OnCreate = DataModuleCreate
  Height = 581
  Width = 595
  object qryEnvaseVariedad: TQuery
  ...
  object kmtEnvasesVariedad: TkbmMemTable
  ...
  object qryImporteEntrega: TQuery
    DatabaseName = 'BDProyecto'
    SQL.Strings = (
  ...
  object kmtEntregas: TkbmMemTable
    DesignActivation = True
    AttachedAutoRefresh = True
    AttachMaxCount = 1
    FieldDefs = <>
  ...
  object qryPaletsProveedor: TQuery
    DatabaseName = 'DBRF'
    SQL.Strings = (
  ...
  object kmtLineasProveedor: TkbmMemTable
    DesignActivation = True
    AttachedAutoRefresh = True
    AttachMaxCount = 1
    FieldDefs = <>
  ...
  object dsProveedor: TDataSource
    DataSet = kmtLineasProveedor
    Left = 128
    Top = 73
  end
  object kmtPaletsProveedor: TkbmMemTable
    DesignActivation = True
    AttachedAutoRefresh = True
    AttachMaxCount = 1
    FieldDefs = <>
  ...
  object kmtOrdenCarga: TkbmMemTable
    DesignActivation = True
    AttachedAutoRefresh = True
    AttachMaxCount = 1
    FieldDefs = <>
