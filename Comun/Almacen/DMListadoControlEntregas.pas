...
begin
  ...
  begin
    ...
    SQL.Add('        (select nombre_p from frf_proveedores where proveedor_p = proveedor_ec ) nomProveedor, ');
    SQL.Add('        almacen_el codAlmacen, ');
    SQL.Add('        (select nombre_pa from frf_proveedores_almacen where proveedor_pa = proveedor_ec and almacen_pa = almacen_el) nomAlmacen, ');
    SQL.Add('        transporte_ec codTransporte, ');
    SQL.Add('        (select descripcion_t from frf_transportistas where transporte_t = transporte_ec) nomTransporte, ');
    ...
    SQL.Add('        producto_el producto, ( select descripcion_p from frf_productos where producto_p = producto_el ) des_producto, empresa_ec,');
