object QLParteProduccionStockConf: TQLParteProduccionStockConf
  Left = 0
  Top = 0
  Width = 794
  Height = 1123
  ...
  object DetailBand1: TQRBand
    ...
    object coste: TQRExpr
      ...
      Transparent = True
      WordWrap = True
      Expression = '[stock_ini_proveedor]'
      Mask = '#,##0'
      FontSize = 7
    end
    ...
    object qrxGeneral: TQRExpr
      ...
      Transparent = True
      WordWrap = True
      Expression = '[stock_ini_confecionado]'
      Mask = '#,##0'
      FontSize = 7
    end
  ...
  object PageHeaderBand1: TQRBand
    ...
    object PsQRLabel1: TQRLabel
      ...
      AutoSize = True
      AutoStretch = False
      Caption = 'STOCK DE PRODUCTO EN RF'
      Color = clWhite
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -24
  ...
  object qrbndTotales: TQRBand
    ...
    object qrxpr5: TQRExpr
      ...
      Transparent = True
      WordWrap = True
      Expression = 'sum([stock_ini_proveedor])'
      Mask = '#,##0'
      FontSize = 7
    end
    object qrxpr15: TQRExpr
      ...
      Transparent = True
      WordWrap = True
      Expression = 'sum([stock_ini_confecionado])'
      Mask = '#,##0'
      FontSize = 7
    end
    object qrxpr16: TQRExpr
      ...
      Transparent = True
      WordWrap = True
      Expression = 'sum([entradas_proveedor])'
      Mask = '#,##0'
      FontSize = 7
    end
    object qrxpr17: TQRExpr
      ...
      Transparent = True
      WordWrap = True
      Expression = 'sum([entradas_transitos])'
      Mask = '#,##0'
      FontSize = 7
    end
