object QRParteEnvases: TQRParteEnvases
  ...
  object BandaCabecera: TQRBand
    ...
    object QRLabel9: TQRLabel
      ...
      AutoSize = True
      AutoStretch = False
      Caption = 'CONFECCIONADO POR ART'#205'CULOS'
      Color = clWhite
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -24
  ...
  object BandaCategoria: TQRGroup
    Left = 38
    Top = 143
    Width = 718
    Height = 20
  ...
  object MemTable: TkbmMemTable
    ...
    IndexDefs = <>
    SortFields = 'producto;categoria;envase'
    SortOptions = []
    ...
    Left = 128
    Top = 32
    object MemTableproducto: TStringField
      FieldName = 'producto'
      Required = True
      FixedChar = True
      Size = 3
  ...
  object ClientDataSet: TClientDataSet
    Aggregates = <>
    IndexFieldNames = 'producto;categoria;envase'
    Params = <>
