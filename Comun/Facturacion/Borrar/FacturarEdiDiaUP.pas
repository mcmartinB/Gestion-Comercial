  ...
  begin
    cabeceras.Add(
        ...
        *)
        ...
        'DIA S.A.' + '|' + //QCabEdi.FieldByName('rsocial_fec').AsString + '|' +
        'C/ Jacinto Benavente, 2 A Parque Empresarial Las Rozas' + '|' + //QCabEdi.FieldByName('domicilio_fec').AsString + '|' +
        'MADRID' + '|' + //QCabEdi.FieldByName('ciudad_fec').AsString + '|' +
        '28232' + '|' + //QCabEdi.FieldByName('cp_fec').AsString + '|' +
        'A28164754' + '|' + //QCabEdi.FieldByName('nif_fec').AsString + '|' +
