...
begin
  with DPFacturarEdi do
  begin
    if QLinEdi.FieldByName('dun14_fel').AsString <> '' then
    begin
      sEan13:= QLinEdi.FieldByName('dun14_fel').AsString;
    end
    else
    begin
      sEan13:= QLinEdi.FieldByName('producto_fel').AsString;
    end;
