object FLGenerarRemesaCobro: TFLGenerarRemesaCobro
  Left = 443
  Top = 212
  ActiveControl = eEmpresa
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = '  GENERAR FICHERO REMESA GIRO'
  ClientHeight = 346
  ClientWidth = 497
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object chkVerificarCCC: TCheckBox
      Left = 136
      Top = 244
      Width = 256
      Height = 17
      Caption = 'Verificar que el IBAN sea correcto.'
      Checked = True
      State = cbChecked
      TabOrder = 15
    end
    object cbbNorma: TComboBox
      Left = 136
      Top = 24
      Width = 304
      Height = 28
