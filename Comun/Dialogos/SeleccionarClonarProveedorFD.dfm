object FDSeleccionarClonarProveedor: TFDSeleccionarClonarProveedor
  Left = 433
  Top = 285
  BorderIcons = []
  ...
  object Panel1: TPanel
    ...
    object lblNueva: TLabel
      ...
      Height = 19
      AutoSize = False
      Caption = ' Nuevo C'#243'digo Proveedor'
      Color = cl3DLight
      ParentColor = False
      Layout = tlCenter
    end
    ...
    object rbClonar: TRadioButton
      ...
      Width = 297
      Height = 17
      Caption = 'Seleccione el c'#243'digo del proveedor que quiere clonar'
      TabOrder = 1
      OnClick = rbClonarClick
    end
    object edtProveedorNew: TBEdit
      Left = 178
      Top = 134
      Width = 49
      Height = 21
