unit RLiquidaCosecheroPeriodoResumen;
...
type
  TQRLiquidaCosecheroPeriodoResumen = class(TQuickRep)
...
var
  QRLiquidaCosecheroPeriodoResumen: TQRLiquidaCosecheroPeriodoResumen;
...
constructor TQRLiquidaCosecheroPeriodoResumen.Create(AOwner: TComponent);
var
  a,b,c: boolean;
begin
  inherited;
...
destructor TQRLiquidaCosecheroPeriodoResumen.Destroy;
begin
