...
type
  TQRLiquidaCosecheroPeriodo = class(TQuickRep)
...
var
  QRLiquidaCosecheroPeriodo: TQRLiquidaCosecheroPeriodo;

implementation

uses CAuxiliar, Principal, UDMAuxDB, bSQLUtils, bMath, ULiquidaCosecheroPeriodo,
  bTimeUtils, ULiquidaCosecheroPeriodoComun, ULiquidaCosecheroPeriodoCosteEnv;
...
function TQRLiquidaCosecheroPeriodo.FobAjustado(
...
procedure TQRLiquidaCosecheroPeriodo.AnyadeNeto(cos, kcos, kapr, kapr1, kapr2, kapr3: integer; brutoFob, gEnv, netoFob, gGEnv, gCom, gAdm, neto: real);
begin
...
procedure TQRLiquidaCosecheroPeriodo.kilosPrint(sender: TObject;
  var Value: string);
var
  aux: real;
begin
...
procedure TQRLiquidaCosecheroPeriodo.QRSubDetail1BeforePrint(
...
procedure TQRLiquidaCosecheroPeriodo.Porcentaje(sender: TObject;
  var Value: string);
begin
...
procedure TQRLiquidaCosecheroPeriodo.lImporteFOBPrint(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', rNetoFOB);
end;

procedure TQRLiquidaCosecheroPeriodo.PsQRLabel45Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', rBrutoFOB);
end;

procedure TQRLiquidaCosecheroPeriodo.QRLLiquidacionCosecherosBeforePrint(
...
procedure TQRLiquidaCosecheroPeriodo.DetailBand1AfterPrint(
...
procedure TQRLiquidaCosecheroPeriodo.lSumImporteFOBPrint(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', rSumNetoFOB);
end;

procedure TQRLiquidaCosecheroPeriodo.PsQRLabel46Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', rSumBrutoFOB);
end;

procedure TQRLiquidaCosecheroPeriodo.PsQRLabel60Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0', iKilosCos);
end;

procedure TQRLiquidaCosecheroPeriodo.lSumKilosAprovechaPrint(sender: TObject;
  var Value: string);
var
  aux: real;
begin
...
procedure TQRLiquidaCosecheroPeriodo.MediaPrecioKiloPrint(sender: TObject;
  var Value: string);
begin
...
procedure TQRLiquidaCosecheroPeriodo.MediaFOBPrint(sender: TObject;
  var Value: string);
begin
  if iSumKilosAprovecha <> 0 then
...
procedure TQRLiquidaCosecheroPeriodo.ps_kilos_cat_1Print(sender: TObject;
  var Value: string);
begin
...
procedure TQRLiquidaCosecheroPeriodo.ps_kilos_cat_2Print(sender: TObject;
  var Value: string);
begin
...
procedure TQRLiquidaCosecheroPeriodo.ps_bruto_cat_1Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', bruto_cat_1);
end;

procedure TQRLiquidaCosecheroPeriodo.ps_bruto_cat_2Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', bruto_cat_2);
end;

procedure TQRLiquidaCosecheroPeriodo.ps_fob_cat_1Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', fob_cat_1);
end;

procedure TQRLiquidaCosecheroPeriodo.ps_fob_cat_2Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', fob_cat_2);
end;

procedure TQRLiquidaCosecheroPeriodo.PsQRLabel59Print(sender: TObject;
  var Value: string);
begin
...
procedure TQRLiquidaCosecheroPeriodo.PsQRLabel61Print(sender: TObject;
  var Value: string);
begin
...
procedure TQRLiquidaCosecheroPeriodo.BandaSeparadorBeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  iSumKilosAprovecha1:= kilos_cat_1;
...
procedure TQRLiquidaCosecheroPeriodo.PsQRLabel66Print(sender: TObject;
  var Value: string);
begin
...
procedure TQRLiquidaCosecheroPeriodo.PsQRLabel67Print(sender: TObject;
  var Value: string);
begin
...
procedure TQRLiquidaCosecheroPeriodo.PsQRLabel64Print(sender: TObject;
  var Value: string);
begin
  if ( lines_cat_1 = 0 ) or ( kilos_cat_1 = 0 )then Value := ''
...
procedure TQRLiquidaCosecheroPeriodo.PsQRLabel65Print(sender: TObject;
  var Value: string);
begin
  if ( lines_cat_2 = 0 ) or ( kilos_cat_2 = 0 ) then Value := ''
...
procedure TQRLiquidaCosecheroPeriodo.PsQRDBText2Print(sender: TObject;
  var Value: string);
begin
  Value := Trim(Value);
end;

procedure TQRLiquidaCosecheroPeriodo.anyoPrint(sender: TObject;
  var Value: string);
begin
  Value := Copy(Value, 1, 4) + ' ' + Copy(Value, 5, 2);
end;

constructor TQRLiquidaCosecheroPeriodo.Create(AOwner: TComponent);
begin
  inherited;
...
destructor TQRLiquidaCosecheroPeriodo.Destroy;
begin
  FreeAndNil(QResumen);
  inherited;
end;

procedure TQRLiquidaCosecheroPeriodo.PsQRLabel72Print(sender: TObject;
  var Value: string);
begin
...
procedure TQRLiquidaCosecheroPeriodo.PsQRLabel73Print(sender: TObject;
  var Value: string);
begin
...
procedure TQRLiquidaCosecheroPeriodo.PsQRLabel74Print(sender: TObject;
  var Value: string);
begin
...
procedure TQRLiquidaCosecheroPeriodo.PsQRLabel75Print(sender: TObject;
  var Value: string);
begin
  if lines_cat_3 = 0 then Value := ''
  else
...
procedure TQRLiquidaCosecheroPeriodo.PsQRLabel76Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', bruto_cat_3);
end;

procedure TQRLiquidaCosecheroPeriodo.PsQRLabel77Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', fob_cat_3);
end;

procedure TQRLiquidaCosecheroPeriodo.BandaSegundaBeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TQRLiquidaCosecheroPeriodo.BandaTerceraBeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  PrintBand := (lines_cat_3 <> 0) and ((lines_cat_1 + lines_cat_2 + lines_cat_3) <> 0);
end;

procedure TQRLiquidaCosecheroPeriodo.lFOBPrint(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.000', rFob);
end;

procedure TQRLiquidaCosecheroPeriodo.PsQRDBText3Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.000', rCoste);
end;

procedure TQRLiquidaCosecheroPeriodo.PsQRDBText6Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.000', rFobReal);
end;

procedure TQRLiquidaCosecheroPeriodo.ChildBand5BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  PrintBand := not bNuevoCosechero;
end;

procedure TQRLiquidaCosecheroPeriodo.bnd1ResumenBeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  PrintBand := (lines_cat_1 <> 0) and ((lines_cat_1 + lines_cat_2 + lines_cat_3) <> 0);
end;

procedure TQRLiquidaCosecheroPeriodo.bnd2ResumenBeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  PrintBand := (lines_cat_2 <> 0) and ((lines_cat_1 + lines_cat_2 + lines_cat_3) <> 0);
end;

procedure TQRLiquidaCosecheroPeriodo.bnd3ResumenBeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  PrintBand := (lines_cat_3 <> 0) and ((lines_cat_1 + lines_cat_2 + lines_cat_3) <> 0);
end;

procedure TQRLiquidaCosecheroPeriodo.bndPieResumenAfterPrint(
  Sender: TQRCustomBand; BandPrinted: Boolean);
begin
  AnyadeNeto(
  ...
  if iCosecheros < iCosecherosTotal then
    QRLiquidaCosecheroPeriodo.NewPage;
end;

procedure TQRLiquidaCosecheroPeriodo.PsQRLabel42Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', bruto_cat_1 - fob_cat_1);
end;

procedure TQRLiquidaCosecheroPeriodo.PsQRLabel44Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', bruto_cat_2 - fob_cat_2);
end;

procedure TQRLiquidaCosecheroPeriodo.PsQRLabel78Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', bruto_cat_3 - fob_cat_3);
end;

procedure TQRLiquidaCosecheroPeriodo.PsQRLabel84Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', rSumBrutoFOB - rSumNetoFOB);
end;

procedure TQRLiquidaCosecheroPeriodo.bndCabResumenBeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
var
  costes , aux: real;
begin
...
procedure TQRLiquidaCosecheroPeriodo.PsQRLabel86Print(sender: TObject;
  var Value: string);
begin
...
procedure TQRLiquidaCosecheroPeriodo.PsQRLabel87Print(sender: TObject;
  var Value: string);
begin
...
procedure TQRLiquidaCosecheroPeriodo.PsQRLabel91Print(sender: TObject;
  var Value: string);
begin
...
procedure TQRLiquidaCosecheroPeriodo.PsQRLabel94Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', liq_cat1);
end;

procedure TQRLiquidaCosecheroPeriodo.PsQRLabel98Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', liq_cat2);
end;

procedure TQRLiquidaCosecheroPeriodo.PsQRLabel99Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', liq_cat3);
end;

procedure TQRLiquidaCosecheroPeriodo.PsQRLabel93Print(sender: TObject;
  var Value: string);
begin
...
procedure TQRLiquidaCosecheroPeriodo.PsQRLabel100Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', liq_cat1 + liq_cat2 + liq_cat3 + liq_cat4);
end;

procedure TQRLiquidaCosecheroPeriodo.valComerPrint(sender: TObject;
  var Value: string);
begin
...
procedure TQRLiquidaCosecheroPeriodo.valProdPrint(sender: TObject;
  var Value: string);
begin
(*
...
procedure TQRLiquidaCosecheroPeriodo.valAdmiPrint(sender: TObject;
  var Value: string);
begin
...
procedure TQRLiquidaCosecheroPeriodo.BandaCuartaBeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  PrintBand := lines_cat_4 <> 0;
end;

procedure TQRLiquidaCosecheroPeriodo.QRLabel3Print(sender: TObject;
  var Value: string);
begin
...
procedure TQRLiquidaCosecheroPeriodo.QRLabel4Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0', kilos_cat_4);
end;

procedure TQRLiquidaCosecheroPeriodo.QRLabel5Print(sender: TObject;
  var Value: string);
begin
...
procedure TQRLiquidaCosecheroPeriodo.QRLabel6Print(sender: TObject;
  var Value: string);
begin
  if (lines_cat_4 = 0) or (kilos_cat_4 = 0) then Value := ''
...
procedure TQRLiquidaCosecheroPeriodo.QRLabel7Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', bruto_cat_4);
end;

procedure TQRLiquidaCosecheroPeriodo.QRLabel8Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', fob_cat_4);
end;

procedure TQRLiquidaCosecheroPeriodo.QRLabel10Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0', kilos_cat_4);
end;

procedure TQRLiquidaCosecheroPeriodo.QRLabel11Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', bruto_cat_4);
end;

procedure TQRLiquidaCosecheroPeriodo.QRLabel12Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', bruto_cat_4 - fob_cat_4);
end;

procedure TQRLiquidaCosecheroPeriodo.QRLabel13Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', fob_cat_4);
end;

procedure TQRLiquidaCosecheroPeriodo.QRLabel14Print(sender: TObject;
  var Value: string);
begin
...
procedure TQRLiquidaCosecheroPeriodo.QRLabel15Print(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0.00', liq_cat4);
end;

procedure TQRLiquidaCosecheroPeriodo.bnd4ResumenBeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  PrintBand := (lines_cat_4 <> 0);
end;

procedure TQRLiquidaCosecheroPeriodo.lCatPrint(sender: TObject;
  var Value: string);
begin
  if Value = '4' then
    Value := 'D';
...
procedure TQRLiquidaCosecheroPeriodo.lblKilos12aPrint(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#,##0', kilos_cat_1 + kilos_cat_2);
end;

procedure TQRLiquidaCosecheroPeriodo.lblRComerPrint(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#0.0000', rComercial);
end;

procedure TQRLiquidaCosecheroPeriodo.lblRProdPrint(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('#0.0000', rProduccion);
end;

procedure TQRLiquidaCosecheroPeriodo.lblRAdmiPrint(sender: TObject;
  var Value: string);
begin
