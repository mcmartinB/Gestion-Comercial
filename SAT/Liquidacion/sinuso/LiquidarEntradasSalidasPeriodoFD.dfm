object FDLiquidarEntradasSalidasPeriodo: TFDLiquidarEntradasSalidasPeriodo
  Left = 462
  Top = 228
  BorderIcons = []
  ...
  object Panel2: TPanel
    ...
    object cbbTipo: TComboBox
      ...
      Items.Strings = (
        'No definitivas'
        'Recalcular las definitivas')
    end
    object chkDefinitiva: TCheckBox
      Left = 302
      Top = 174
      Width = 167
      Height = 17
      Caption = 'Marcar como definitiva'
      TabOrder = 10
    end
  end
