...
begin
  ...
  DireccionFactura( QDatos.FieldByName('planta_destino_tc').AsString );
...
begin
  ...
  begin
    SQL.Clear;
    SQL.Add('select empresa_tc, referencia_tc, fecha_tc, planta_destino_tc, transporte_tc, vehiculo_tc, buque_tc, puerto_tc, destino_tc,');
    ...
    SQL.Add('       sum(  round( ( cajas_tl * nvl(peso_envase_e,0) ), 2 ) + kilos_tl ) kilos_bru_tl , ');
    ...
    SQL.Add('group by empresa_tc, referencia_tc, fecha_tc, planta_destino_tc, transporte_tc, vehiculo_tc, buque_tc, puerto_tc, destino_tc, ');
    SQL.Add('         precio_palet_plas_tc, precio_caja_plas_tc, ');
    SQL.Add('         incoterm_tc, plaza_incoterm_tc, producto_tl, precio_tl ');
