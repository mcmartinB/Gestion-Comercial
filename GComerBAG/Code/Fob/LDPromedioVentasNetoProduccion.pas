...
type
  ...
  public
    ...
    function  PromedioVentasNetoProduccion(
             ...
             const ADescuento, AGastosSalidas, AGastosTransitos, AEnvasado, ASecciones, AAbonos,
    ...
    function CargaTabla( const ADescuento,  AGastosSalidas, AGastosTransitos,
                                AEnvasado, ASecciones, AAbonos: boolean ): real;
...
begin
  ...
  try
    result:= DLPromedioVentasNetoProduccion.PromedioVentasNetoProduccion(
               ...
               ADescuento, AGastosSalidas, AGastosTransitos, AEnvasado, ASecciones, AAbonos,
...
begin
  ...
  begin
    ...
    begin
      ...
      SQL.Add('       where cliente_c = cliente_sl ) = :pais ');
    end;
...
var
  rKilos, rImporte, rGastoSalidas, rGastoTransitos, rCosteEnvasado,
    rDescuento, rNetoCampo, rNetoProduccion: real;
  rAux: real;
begin
  rKilos:= 0;
  rImporte:= 0;
