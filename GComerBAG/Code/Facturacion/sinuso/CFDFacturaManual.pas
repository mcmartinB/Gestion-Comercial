...
begin
  ...
  if RealCorrecto( neto_fal, 'El importe del albarán ', rNetoAlb ) then
  if RealCorrecto( porc_descuento_fal, 'El descuento del albarán ', rPorcDescuentoAlb ) then
  if RealCorrecto( descuento_fal, 'El descuento del albarán ', rDescuentoAlb ) then
