object DFDFacturaManual: TDFDFacturaManual
  ...
  object rbSuper: TRadioButton
    ...
    Width = 115
    Height = 17
    Caption = '0- Super Reducido'
    TabOrder = 8
    OnClick = rbSuperClick
  end
  ...
  object rbReducido: TRadioButton
    Left = 263
    Top = 154
    Width = 115
    Height = 17
  ...
  object porc_descuento_fal: TBEdit
    Left = 496
    Top = 311
    Width = 23
    Height = 21
  ...
  object edtImporteBruto: TBEdit
    ...
    MaxLength = 11
    TabOrder = 10
    OnChange = edtImporteBrutoChange
  end
end
