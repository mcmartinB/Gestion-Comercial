...
begin
  ...
  begin
    ...
    SQL.Add('              where envase_e = envase_sl and producto_e = producto_sl ) codigo, ');
    (*LOGI*)
...
begin
  ...
  begin
    ...
    *)
    ...
    SQL.Add('             where empresa_ce = :empresa  and cliente_ce = :cliente and envase_ce = envase_sl ) )descripcion, ');
