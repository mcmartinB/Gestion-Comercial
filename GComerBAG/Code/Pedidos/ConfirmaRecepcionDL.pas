...
begin
  ...
  begin
    ...
    SQL.Add('          where empresa_ce = :empresa  and cliente_ce = :cliente and envase_ce = envase_sl  ');
    SQL.Add('    and producto_ce = producto_sl ) codigo,');
    ...
    SQL.Add('             where empresa_ce = :empresa  and cliente_ce = :cliente and envase_ce = envase_sl    ');
    SQL.Add('    and producto_ce = producto_sl) )descripcion, ');
