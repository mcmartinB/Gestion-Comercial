object QRLFacturaLogifruit: TQRLFacturaLogifruit
  ...
  object qrbndSummaryBand1: TQRBand
    ...
    object qrlbl21: TQRLabel
      ...
      AutoSize = True
      AutoStretch = False
      Caption = 'TR'#193'NSITOS ENTRE CENTROS'
      Color = clWhite
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
    ...
    object qrxpr25: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(IF([tipo]='#39'3'#39',[env_0081],0))'
      Mask = '#,##0'
      FontSize = 10
    end
    object qrxpr26: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(IF([tipo]='#39'3'#39',[env_0316],0))'
      Mask = '#,##0'
      FontSize = 10
    end
    object qrxpr27: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(IF([tipo]='#39'3'#39',[env_0618],0))'
      Mask = '#,##0'
      FontSize = 10
    end
    object qrxpr28: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(IF([tipo]='#39'3'#39',[env_3416],0))'
      Mask = '#,##0'
      FontSize = 10
    end
    object qrxpr29: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(IF([tipo]='#39'3'#39',[env_6412],0))'
      Mask = '#,##0'
      FontSize = 10
    end
    object qrxpr30: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum(IF([tipo]='#39'3'#39',[env_restos],0))'
      Mask = '#,##0'
      FontSize = 10
    end
  end
