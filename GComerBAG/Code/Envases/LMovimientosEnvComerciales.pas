...
procedure TQRLMovimientosEnvComerciales.qrdbtxtoperador1Print(sender: TObject;
  var Value: String);
begin
...
begin
  ...
  //entradas transitos cajas
  else if DataSet.FieldbyName('tipo').AsString = '3' then
    qrlblAlmacen.Caption := DataSet.FieldbyName('almacen').AsString  + ' ' +
                            desCentro( DataSet.FieldbyName('empresa').AsString,
                                                DataSet.FieldbyName('almacen').AsString )
  //entradas transitos fruta
  else if DataSet.FieldbyName('tipo').AsString = '4' then
    qrlblAlmacen.Caption := DataSet.FieldbyName('cliente').AsString + ' ' + DataSet.FieldbyName('almacen').AsString  + ' ' +
                            desCentro( DataSet.FieldbyName('cliente').AsString,
                                                DataSet.FieldbyName('almacen').AsString )

  //salidas transitos cajas
