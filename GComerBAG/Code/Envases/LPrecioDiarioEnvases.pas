...
type
  TQRLPrecioDiarioEnvases = class(TQuickRep)
    ...
    procedure qreproducto_epdPrint(sender: TObject; var Value: String);
  private
...
procedure TQRLPrecioDiarioEnvases.qreproducto_epdPrint(sender: TObject;
  var Value: String);                                                                 
begin
