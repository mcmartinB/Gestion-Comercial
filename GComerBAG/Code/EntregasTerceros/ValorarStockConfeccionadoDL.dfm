object DLValorarStockConfeccionado: TDLValorarStockConfeccionado
  ...
  object kmtStockValoradoDet: TkbmMemTable
    DesignActivation = True
    AttachedAutoRefresh = True
    AttachMaxCount = 1
    FieldDefs = <>
  ...
  object dsStockValorado: TDataSource
    DataSet = kmtStockValorado
    Left = 174
    Top = 20
  end
  object qryImporteGastos: TQuery
    DatabaseName = 'BDProyecto'
    SQL.Strings = (
