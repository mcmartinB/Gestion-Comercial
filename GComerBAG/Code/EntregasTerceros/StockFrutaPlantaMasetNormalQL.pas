...
begin
  ...
  try
    QLStockFrutaPlantaMasetNorma.PreparaListado( AEmpresa, ACentro, AProducto, AEntrega, '', AAnyoSemana,
...
begin
  QLStockFrutaPlantaMasetNorma:= TQLStockFrutaPlantaMasetNormal.Create( AOwner );
  try
    QLStockFrutaPlantaMasetNorma.PreparaListado( AEmpresa, ACentro, '', '', DateToStr( AFechaIni ), -1,
...
procedure TQLStockFrutaPlantaMasetNormal.PreparaListado( const AEmpresa, ACentro, AProducto, AEntrega, AFecha: string;
                                                   const AAnyoSemana: Integer;
                                                   const AProveedor, Variedad, ACalibre, APais, AFechaIni, AFechaFin: string );
begin
