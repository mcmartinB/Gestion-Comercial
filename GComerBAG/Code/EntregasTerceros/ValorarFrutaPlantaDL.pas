...
type
  ...
  public
    { Public declarations }
    function DatosQueryStock( const AEmpresa, AProducto, AEntregaDesde, AEntregaHasta: string ): boolean;
...
//    SQL.Add(' and tipo_ge <> ''001'' ');
    SQL.Add(' and tipo_ge <> ''052'' ');
...
begin
  ...
  begin
    ...
    SQL.Add(' WHERE rf_palet_pb.entrega between :entregadesde and :entregahasta');
    (*
...
function TDLValorarFrutaPlanta.DatosQueryStock( const AEmpresa, AProducto, AEntregaDesde, AEntregaHasta: string ): boolean;
begin
