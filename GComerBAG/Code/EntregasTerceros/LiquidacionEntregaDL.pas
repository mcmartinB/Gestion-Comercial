...
type
  ...
  private
    ...
    procedure KilosLiquidar( const AEntrega, AProducto, AVariedad, ACalibre: string;
                             var VKilosProducto, VKilosLiquidar: real );
    ...
    procedure CosteCompra( const AEntrega: string;
                          const AKilosProducto, AKilosLiquidar: Real );
...
begin
  ...
  begin
    ...
    SQL.Add('        producto, producto_pl, rf_palet_pb.variedad, envase_pl, calibre, calibre_pl, ');
  ...
  begin
    ...
    SQL.Add('        producto, rf_palet_pb.variedad, envase_pl, calibre, sum( peso_pl ) kilos_pl ');
...
function TDLLiquidacionEntrega.DatosLiquidacion( const AEntrega, AProducto, AVariedad, ACalibre, AProveedor: string;
                                                 const AKilosAjusteVentas, AKilosAjusteDestrio,
                                                       AImportePteVta, AImporteDestrio: real  ): boolean;
var
  rKilosProducto, rKilosLiquidar: real;
begin
  KilosLiquidar( AEntrega, AProducto, AVariedad, ACalibre, rKilosProducto, rKilosLiquidar );
  ...
  begin
    ...
    CosteCompra( AEntrega, rKilosProducto, rKilosLiquidar );
...
procedure TDLLiquidacionEntrega.CosteCompra( const AEntrega: string;
                                             const AKilosProducto, AKilosLiquidar: Real );
var
  rCoste, rAcum: Real;
begin
