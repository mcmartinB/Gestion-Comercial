object FLStockFrutaPlanta: TFLStockFrutaPlanta
  ...
  object lblSemana: TLabel
    ...
    Height = 13
    AutoSize = False
    Caption = '(Optativo, formato aaaass)'
  end
  object lblPlaceros: TLabel
    Left = 1
    Top = 6
    Width = 561
    Height = 16
    Caption = 
      'Para la planta F17 podemos indicar si queremos el Stock de verde' +
      ' y de placeros'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clRed
    Font.Height = -13
  ...
  object cbbPlaceros: TComboBox
    ...
    ItemIndex = 0
    TabOrder = 1
    Text = 'Ignorar placeros/verde'
    Items.Strings = (
      'Ignorar placeros/verde'
      'Ver placeros/verde'
      'Solo placeros/verde')
  end
end
