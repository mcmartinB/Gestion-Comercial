...
begin
  ...
  try
    QLCosteFrutaProveedor.PreparaListado( AEmpresa, ACentro, AProducto, AProveedor, AEntrega, AFechaDesde, AFechaHasta );
...
begin
  ...
  try
    result:= DLCosteFrutaProveedor.DatosQueryFrutaProveedor( AEmpresa, ACentro, AProducto, AProveedor, AEntrega, AFechaDesde,
                                                             AFechaHasta, AAgruparVariedad, AAgruparCalibre, AMensaje );
    if result then
    begin
      VerListadoStockEx( AOwner, AEmpresa, ACentro, AProducto, AProveedor, AEntrega, AFechaDesde, AFechaHasta, AAgruparVariedad, AAgruparCalibre, AVerDetalle );
    end;
  finally
...
procedure TQLCosteFrutaProveedor.PreparaListado( const AEmpresa, ACentro, AProducto, AProveedor, AEntrega, AFechaDesde, AFechaHasta: string );
begin
