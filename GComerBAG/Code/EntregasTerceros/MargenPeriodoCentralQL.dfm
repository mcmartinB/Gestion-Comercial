object QLMargenPeriodoCentral: TQLMargenPeriodoCentral
  Left = 0
  Top = 0
  Width = 1123
  Height = 794
  ...
  DataSet = DLMargenBeneficiosCentral.mtResumen
  ...
  object bnddDetProveedor: TQRSubDetail
    ...
    KeepOnOnePage = False
    Master = Owner
    DataSet = DLMargenBeneficiosCentral.mtPrecios
  ...
  object bnddPaletsConfeccionados: TQRSubDetail
    ...
    KeepOnOnePage = False
    Master = Owner
    DataSet = DLMargenBeneficiosCentral.mtPaletsConfeccionados
  ...
  object bndCabPaletsProveedores: TQRGroup
    ...
    object qregrupo_in: TQRDBText
      ...
      AutoStretch = False
      Color = clWhite
      DataSet = DLMargenBeneficiosCentral.mtPaletsProveedor
      DataField = 'grupo_in'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
