...
function TFLSalidasSuministro.DatosEmpresa: string;
begin
  if Not( chkF17.Checked or chkF18.Checked or chkF21.Checked or
     chkF23.Checked or chkF24.Checked ) then
  begin
    result:= QuotedStr( Trim( edtEmpresa.Text ) );
  end
  else
  begin
    result:= '';
    if chkF17.Checked then
    begin
      result:= '''F17''';
    end;
    if chkF18.Checked then
    begin
      if result <> '' then
        result:= result + ',';
      result:= result + '''F18''';
    end;
    if chkF21.Checked then
    begin
      if result <> '' then
        result:= result + ',';
      result:= result + '''F21''';
    end;
    if chkF23.Checked then
    begin
      if result <> '' then
        result:= result + ',';
      result:= result + '''F23''';
    end;
    if chkF24.Checked  then
    begin
      if result <> '' then
        result:= result + ',';
      result:= result + '''F24''';
...
begin
  ...
  begin
    Parametros.sEmpresa:= DatosEmpresa;
