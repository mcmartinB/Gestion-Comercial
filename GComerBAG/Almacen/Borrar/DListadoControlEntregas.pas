...
begin
  if eEmpresa.Text <> '' then
  begin
    result:= ' select empresa_p, proveedor_p, nombre_p from frf_proveedores ' +
             ' where empresa_p ' + SQLEqualS( eEmpresa.Text ) +
             ' order by empresa_p, proveedor_p ';
  end
  else
  begin
    result:= ' select empresa_p, proveedor_p, nombre_p from frf_proveedores order by empresa_p, proveedor_p ';
  end;
end;
...
begin
  if eEmpresa.Text <> '' then
  begin
    result:= ' select empresa_pa, proveedor_pa, almacen_pa, nombre_pa from frf_proveedores_almacen ' +
             ' where empresa_pa ' + SQLEqualS( eEmpresa.Text );
    if eProveedor.Text <> '' then
    begin
      result:= result + ' and proveedor_pa ' + SQLEqualS( eProveedor.Text );
    end;
    result:= result + ' order by empresa_pa, proveedor_pa ';
