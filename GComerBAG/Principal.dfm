  ...
  object MenuPrincipal: TMainMenu
    ...
    object mnuFicheros: TMenuItem
      ...
      object mnuFchAgrupacionesEnvase: TMenuItem
        Caption = 'Agrupaciones Envase'
        OnClick = mnuFicherosClick
      end
      object mnuFchAgrupacionesGasto: TMenuItem
      ...
      object mnuFchListadoComisiones: TMenuItem
        Caption = 'Clientes - Listado Descuentos/Comisiones'
        OnClick = mnuFicherosClick
      end
      object mnnFchClientesListadoFormaPago: TMenuItem
        Caption = 'Clientes - Listado Forma de Pago'
        OnClick = mnuFicherosClick
      end
      object mnuFchEan13: TMenuItem
        Caption = 'C'#243'digos EAN13 de Art'#237'culos'
        OnClick = mnuFicherosClick
      end
      ...
      object mnuFchLineasProductos: TMenuItem
        Caption = 'Productos - L'#237'neas'
        OnClick = mnuFicherosClick
      end
      ...
      object mnuFchProveedoresFincas: TMenuItem
        Caption = 'Proveedores - Fincas'
        OnClick = mnuFicherosClick
      end
      object mnuTipoCostes: TMenuItem
        Caption = 'Tipo Costes Proveedor'
        OnClick = mnuFicherosClick
      end
    ...
    object mnuComprasProveedor: TMenuItem
      ...
      object mnuEntLstControlGastosEntregas: TMenuItem
        Caption = 'Control Gastos de Entregas'
        OnClick = mnuComprasClick
      end
      ...
      object mnuEntPaletsProveedorVolcados: TMenuItem
        Caption = 'Palets Proveedor Volcados'
        OnClick = mnuComprasClick
      end
      ...
      object mnuEntPaletsConfeccionados: TMenuItem
        Caption = 'Palets Confeccionados'
        OnClick = mnuComprasClick
      end
      object mnuEntListadoDestrioFrutaRF: TMenuItem
        Caption = 'Listado Destrio Fruta RF'
        OnClick = mnuComprasClick
      end
      ...
      object mnuEntBeneficioProducto: TMenuItem
      ...
      object mnuEntDifKilosComerRF: TMenuItem
        Caption = 'Diferencias Kilos/Cajas Comercial-Radiofrecuencia'
        OnClick = mnuComprasClick
      end
      object mnuEntDifFechasComerRF: TMenuItem
        Caption = 'Diferencias Fechas Comercial-Radiofrecuencia'
        OnClick = mnuComprasClick
      end
      object mnuEntLiquidacionEntrega: TMenuItem
        Caption = 'Liquidaci'#243'n Entrega'
        OnClick = mnuComprasClick
      end
      object mnuEntPrevisionCostesProducto: TMenuItem
        Caption = 'Previsi'#243'n Costes Producto'
        OnClick = mnuComprasClick
      end
      object mniEntMargenBeneficio: TMenuItem
        Caption = 'NUEVO Margen Beneficio (EN DESARROLLO)'
        OnClick = mnuComprasClick
      end
      object mnuEntMargenPeriodo: TMenuItem
        Caption = 'Margen Beneficio Periodo'
        OnClick = mnuComprasClick
      end
      object mnuEntMargenSemanal: TMenuItem
        Caption = 'Margen Beneficio Semanal'
        OnClick = mnuComprasClick
      end
      object mnuEntCuadreSemanalRFAlmacen: TMenuItem
        Caption = 'Cuadre Semanal RF Almac'#233'n'
        OnClick = mnuComprasClick
      end
    ...
    object mnuAlmacen: TMenuItem
      ...
      object mnuAlmPreciosDiariosrEnvases: TMenuItem
        Caption = 'Precios Diarios por Art'#237'culos'
        OnClick = mnuAlmacenClick
      end
      ...
      object mnuAlmCostesEnvase: TMenuItem
        Caption = 'Costes del Envase'
        OnClick = mnuAlmacenClick
      end
      object mnuAlmPrecioLiquidacion: TMenuItem
        Caption = 'Grabar Precio para Proveedores a Liquidar'
        OnClick = mnuAlmacenClick
      end
      object mnuAlmEnvasesSinCoste: TMenuItem
        Caption = 'Art'#237'culos Sin Coste'
        OnClick = mnuAlmacenClick
      end
      ...
      object mnuAlmLstCosteEnvase: TMenuItem
        Caption = 'Listado Costes Envase'
        OnClick = mnuAlmacenClick
      end
      object mnuAlmCostesEstadisticosdeEnvasadoKg: TMenuItem
        Caption = 'Costes Estad'#237'sticos de Envasado por Kg'
        OnClick = mnuAlmacenClick
      end
      object mnuAlmTablaAnualCosteKgEnvasado: TMenuItem
        Caption = 'Tabla Anual Coste Kg Envasado'
        OnClick = mnuAlmacenClick
      end
      object mnuAlmsepCostesIndirectos: TMenuItem
        Caption = '-'
      end
      ...
      object mnuAlmSepCostesSecciones: TMenuItem
        Caption = '-'
        Hint = 'Coste Secciones'
      end
      object mnuAlmTipoSecciones: TMenuItem
        Caption = 'Tipo de Secciones'
        OnClick = mnuAlmacenClick
      end
      object mnuAlmSeccionesCosechero: TMenuItem
        Caption = 'Secciones por Cosechero/Proveedor'
        OnClick = mnuAlmacenClick
      end
      object mnuAlmCosteSecciones: TMenuItem
        Caption = 'Coste Kg por Seccion Mensual'
        OnClick = mnuAlmacenClick
      end
      object mnuAlmFichaSecciones: TMenuItem
        Caption = 'Ficha Secciones Actual'
        OnClick = mnuAlmacenClick
      end
      object mnuAlmSepPartes: TMenuItem
        Caption = '-'
      end
      object mnuAlmKilosLiquidacionPlatanos: TMenuItem
        Caption = 'Verificar Cajas/Kilos Entregados'
        OnClick = mnuAlmacenClick
      end
      object mnuAlmValorarCargaDirecta: TMenuItem
        Caption = 'Precios Venta Carga Directa'
        OnClick = mnuAlmacenClick
      end
      object mnuAlmSepLiquidarPlatano: TMenuItem
        Caption = '-'
        Hint = 'Liquidaci'#243'n Pl'#225'tano'
      end
      object mnuAlmValorarPaletsEntrega: TMenuItem
        Caption = 'Valorar Palets Entrega'
        OnClick = mnuAlmacenClick
      end
      object mnuAlmLiquidarEntregas: TMenuItem
        Caption = 'Liquidaci'#243'n Entregas RF'
        OnClick = mnuAlmacenClick
      end
      object mnuAlmLiquidarVerde: TMenuItem
        Caption = 'Liquidaci'#243'n Entregas Verde'
        OnClick = mnuAlmacenClick
      end
      object mnuAlmLiquidarPlatano: TMenuItem
        Caption = 'Liquidaci'#243'n Pl'#225'tano'
        OnClick = mnuAlmacenClick
      end
      object mnuAlmSepMargen: TMenuItem
        Caption = '-'
      end
      object mnuAlmValorarFrutaProveedor: TMenuItem
        Caption = 'Valorar Fruta Proveedor'
        OnClick = mnuAlmacenClick
      end
      object mnuAlmResumenConsumoEntrega: TMenuItem
        Caption = 'Resumen Consumo por Entrega'
        OnClick = mnuAlmacenClick
      end
      object mnuAlmParteProduccion: TMenuItem
    ...
    object mnuTransitos: TMenuItem
      ...
      object mnuTraLisFacGasTransitos: TMenuItem
        Caption = 'Listado Facturas Gastos Tr'#225'nsitos'
        OnClick = mnuTransitosClick
      end
    ...
    object mnuPedidos: TMenuItem
      ...
      object mnuPedPedidosFormato: TMenuItem
        Caption = 'Proceso de Pedidos'
        OnClick = mnuPedidosClick
      end
    ...
    object mnuSalidas: TMenuItem
      ...
      object mnuTablaDinamicaSalidas: TMenuItem
        Caption = 'Tabla Din'#225'mica Salidas'
        OnClick = mnuSalidasClick
      end
      object mnuSalResumenSalidasDinamico: TMenuItem
        Caption = 'Resumen Salidas Din'#225'mico'
        OnClick = mnuSalidasClick
      end
      ...
      object mnuSalLisSalidasSuper: TMenuItem
        Caption = 'Listado de Salidas por Supermercados'
        OnClick = mnuSalidasClick
      end
      ...
      object mnuSalResumendeSalidasporProducto: TMenuItem
        Caption = 'Resumen de Salidas por Producto'
        OnClick = mnuSalidasClick
      end
      object mnuSalLisSalidasCategoriaCalibre: TMenuItem
      ...
      object mnuSalEnvioAlbaranes: TMenuItem
        Caption = 'Env'#237'o de Albaranes por Correo Electronico'
        OnClick = mnuSalidasClick
      end
      ...
      object Gastos: TMenuItem
        ...
        object mnuSalGrabarGastosTransporte: TMenuItem
        ...
        object mnuSalFacGasVentas: TMenuItem
          Caption = 'Listado Facturas de Gastos Ventas'
          OnClick = mnuSalidasClick
        end
        object mnuSalFacControlGasVentas: TMenuItem
          Caption = 'Control Gastos de Ventas'
          OnClick = mnuSalidasClick
        end
        object mnuSalServiciosTransporteImporte: TMenuItem
          Caption = 'Resumen Servicios por Transportista - Importe Fruta'
          OnClick = mnuSalidasClick
        end
        object mnuSalServiciosTransporteTransporte: TMenuItem
          Caption = 'Resumen Servicios por Transportista - Coste Transporte'
          OnClick = mnuSalidasClick
        end
      end
      ...
      object EnvasesComercialesRetornables1: TMenuItem
      ...
      object mnuSalVentasSemEnvases: TMenuItem
        Caption = 'Informe de Ventas Semanal por Art'#237'culos '
        OnClick = mnuSalidasClick
      end
      ...
      object mnuSalVentasSuministro: TMenuItem
        Caption = 'Resumen Ventas Por Suministro'
        OnClick = mnuSalidasClick
      end
      ...
      object mnuSalVentasPais: TMenuItem
        Caption = 'Listado de Ventas por Pa'#237's'
        OnClick = mnuSalidasClick
      end
      object mnuSalVentasMensuales: TMenuItem
        Caption = 'Precios de Venta Mensuales'
        OnClick = mnuSalidasClick
      end
      object mnuSalComparativaVentas: TMenuItem
        Caption = 'Comparativa Semanal de Ventas (Bruto)'
        OnClick = mnuSalidasClick
      end
      object mnuSalFacturasAlbaran: TMenuItem
        Caption = 'Listado Facturas Albar'#225'n'
        OnClick = mnuSalidasClick
      end
      object mnuSalSalidasFactura: TMenuItem
        Caption = 'Listado de Salidas por N'#250'mero de Factura'
        OnClick = mnuSalidasClick
      end
      object mnuSalCuentaVentasSinFacturar: TMenuItem
        Caption = 'Listado de Cuenta de Ventas - Sin Facturar'
        OnClick = mnuSalidasClick
      end
      object mnuSalCuentaVentasFacturadas: TMenuItem
        Caption = 'Listado de Cuenta de Ventas - Facturadas'
        OnClick = mnuSalidasClick
      end
      ...
      object mnuSalFOBTabla: TMenuItem
        Caption = 'Tabla Ventas FOB'
        OnClick = mnuSalidasClick
      end
      ...
      object mnuSalFOBEnvases: TMenuItem
        Caption = 'Resumen Ventas FOB por Envase'
        OnClick = mnuSalidasClick
      end
      object mnuSalFOBCalibres: TMenuItem
        Caption = 'Resumen Ventas FOB por Calibre'
        OnClick = mnuSalidasClick
      end
      object mnuSalPromedioVentasProduccion: TMenuItem
        Caption = 'Promedio Ventas Neto Producci'#243'n'
        OnClick = mnuSalidasClick
      end
      object mnuSalSepDUA: TMenuItem
        Caption = '-'
        Hint = 'D.U.A.'
      end
      object mnuSalAsignarDUA: TMenuItem
        Caption = 'Asignar D.U.A.'
        OnClick = mnuSalidasClick
      end
      object mnuSalSepParaMercadona: TMenuItem
        Caption = '-'
        Hint = 'Para Mercadona'
      end
      ...
      object mnuSalSalidasLPR: TMenuItem
        Caption = 'Generaci'#243'n Fichero LPR'
        OnClick = mnuSalidasClick
      end
    end
    object mnuFacturacion: TMenuItem
      ...
      object mnuProcFacturacion: TMenuItem
        Caption = 'Facturacion Autom'#225'tica '
        OnClick = mnuFacturacionClick
      end
      ...
      object mnuFacListadoVentasPeriodo: TMenuItem
        Caption = 'Listado Ventas Periodo'
        OnClick = mnuFacturacionClick
      end
      ...
      object mnuFacNotificacionCredito: TMenuItem
        Caption = 'Notificaci'#243'n de Cr'#233'dito'
        OnClick = mnuFacturacionClick
      end
      ...
      object mnuFacParaAnticipar: TMenuItem
      ...
      object mnuManRemesas: TMenuItem
        Caption = 'Grabacion de Remesa (Des)'
        OnClick = mnuFacturacionClick
      end
      object mnuFacListadoRemesas: TMenuItem
        Caption = 'Resumen Remesas'
        OnClick = mnuFacturacionClick
      end
      ...
      object mnuFacDiasMediosPagoClientes: TMenuItem
        Caption = 'Dias Medios de Pago Clientes'
        OnClick = mnuFacturacionClick
      end
      object mnuFacSaldoPendienteCobro: TMenuItem
        Caption = 'Saldo Cliente - Pendiente Cobro'
        OnClick = mnuFacturacionClick
      end
    end
    object mnuDatosTransmision: TMenuItem
      Caption = 'Tra&nsmisi'#243'n'
      object mnuDatSepInicial: TMenuItem
        Caption = '-'
        Hint = 'Diario'
      end
      object mnuDatPedidos: TMenuItem
        Caption = 'Pedidos'
        OnClick = mnuTransmisionClick
      end
      object mnuDatSalidas: TMenuItem
        Caption = 'Salidas'
        OnClick = mnuTransmisionClick
      end
      object mnuDatTransitos: TMenuItem
        Caption = 'Tr'#225'nsitos'
        OnClick = mnuTransmisionClick
      end
      object mnuDatControlEnviodeAlbaranes: TMenuItem
        Caption = 'Control Envio de Albaranes'
        OnClick = mnuTransmisionClick
      end
      object mnuDatSepVisible: TMenuItem
        Caption = '-'
        Visible = False
      end
      object mnuDatCosteEnvase: TMenuItem
    ...
    object mnuUtilidades: TMenuItem
      ...
      object mniCierre: TMenuItem
        Caption = 'Cierre'
        object mniValorarStock: TMenuItem
          Caption = 'Valorar stock'
          OnClick = mnuCierreClick
        end
        object mniComprasTransito: TMenuItem
          Caption = 'Compras en tr'#225'nsito'
          OnClick = mnuCierreClick
        end
      ...
      object mnuUtiPlantillas: TMenuItem
        Caption = 'Plantillas'
        object mnuUtiPlantillaReportes: TMenuItem
          Caption = 'REPORTES'
          OnClick = mnuUtilidadesClick
        end
      end
      object mnuSincronizacion: TMenuItem
        Caption = 'Sincronizaci'#243'n WEB'
        OnClick = mnuUtilidadesClick
      end
    end
