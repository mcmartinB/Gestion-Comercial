...
type
  TQRLSalidasCliente = class(TQuickRep)
    ...
    qrshp1: TQRShape;
    qrlPrecioUnd: TQRLabel;
    qrePrecioUnd: TQRLabel;
...
begin
  ...
  begin
    ...
    if QListado.fieldByName('unidades').AsInteger > 0 then
    begin
      qrlPrecioUnd.Caption:= FormatFloat( '#,##0.0000', rAux / QListado.fieldByName('unidades').AsFloat );
    end
    else
    begin
      qrlPrecioUnd.Caption:= '-';
    end;    
