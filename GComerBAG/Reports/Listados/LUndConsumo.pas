...
type
  TQRLUndConsumo = class(TQuickRep)
    ...
    procedure qrdbtxtproducto_ucPrint(sender: TObject; var Value: string);
...
procedure TQRLUndConsumo.qrdbtxtproducto_ucPrint(sender: TObject;
  var Value: string);
begin
  Value := Value + ' ' +
    desProducto(DMBasedatos.QListado.FieldByName('empresa_uc').AsString, Value);
end;
