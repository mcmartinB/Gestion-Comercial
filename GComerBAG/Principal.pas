...
begin
  ...
  Caption := UpperCase( 'GESTIÓN COMERCIAL ' + arDataConexion[iBDDataConexion].sDescripcion + ' (' +  gsNombre + ')  ' +  gsAplicVersion);
...
begin
  ...
  ConfigurarOpcion(  mnuFchAgrupacionesEnvase, True, 'Agrupaciones Artículos', '');
...
begin
  ...
  ConfigurarOpcion(  mnuEntFacturasPlatano, DMConfig.EsLaFont, 'Facturas Despacho Plátano Canario', '');
  ...
  if DMConfig.EsLaFont then
    ...
    ConfigurarOpcion(  mniEntMargenBeneficio, True , 'NEW - Parte confección (EN DESARROLLO)', '');
...
begin
  ...
  ConfigurarOpcion(  mnuAlmCostesEnvase, True, 'Costes por KG Artículos (Mensual)', '');
  ConfigurarOpcion(  mnuAlmVerificarCosteEnvases, True, 'Verificar Grabación Costes Artículo', '');
  ConfigurarOpcion(  mnuAlmEnvasesSinCoste, True, 'Artículos Sin Costes Grabados', '');
  ConfigurarOpcion(  mnuAlmLstCosteEnvase, True, 'Listado Costes Artículo', '');
  ConfigurarOpcion(  mnuAlmCostesEstadisticosdeEnvasadoKg, True, 'Costes Estadísticos de Envasado por Kg', '');
  ...
  ConfigurarOpcion(  mnuAlmSepLiquidarPlatano, DMConfig.EsLaFont, '-', 'Liquidación Plátano');
  ...
  ConfigurarOpcion(  mnuAlmLiquidarEntregas, DMConfig.EsLaFont, 'Liquidación Entregas Con RF', '');
  ConfigurarOpcion(  mnuAlmLiquidarVerde, DMConfig.EsLaFont, 'Liquidación Entregas Sin RF (F42)', '');
  ConfigurarOpcion(  mnuAlmLiquidarPlatano, DMConfig.EsLaFont, 'Liquidación Platano', '');
  ...
  ConfigurarOpcion(  mnuAlmParteProduccion, True, 'Parte de Producción', '');

  ConfigurarOpcion(  mnuAlmSepPreciosDiarios, DMConfig.EsLaFont, '-', 'Precios Diarios');
  ConfigurarOpcion(  mnuAlmPreciosDiariosrEnvases, false, 'Precios Diarios por Artículo', '');
...
begin
  ...
  ConfigurarOpcion(  mnuTraLisFacGasTransitos, True, 'Listado Facturas Gastos Tránsitos', '');
...
//  ConfigurarOpcion(  mnuPedPedidosEnvase, True, 'Mantenimiento Pedidos por Artículos', '');
  ConfigurarOpcion(  mnuPedPedidosFormato, True, 'Proceso de Pedidos Aplicación WEB', '');
{
  ConfigurarOpcion(  mnuPedSepPedidosAux,True, '-', '');
  ConfigurarOpcion(  mnuPedAlbaranAPedido, True, 'Crear Pedido Desde Albarán', '');
  ...
  ConfigurarOpcion(  mnuPedConfirmaRecepcion, DMConfig.EsLaFont, 'Confirmación de Recepción de Mercancías En Mercadona', '');
{
...
begin
  ...
  ConfigurarOpcion(  mnuTablaDinamicaSalidas, True, 'Tabla Dinámica Salidas', '');
  ...
  ConfigurarOpcion(  mnuSalEnvioAlbaranes, False, 'Envío de Albaranes por Correo Electronico', '');
  ...
  ConfigurarOpcion(  mnuSalSemanalExpediciones, DMConfig.EsLaFont, 'Declaración Semanal de Expediciones', '');
  ...
  ConfigurarOpcion(  mnuSalResSalidasEnvase, True, 'Salidas por Artículos', '');
  ...
  ConfigurarOpcion(  mnuSalVentasSemEnvases, True, 'Ventas Semanal por Artículos', '');
  ...
  ConfigurarOpcion(  mnuSalVentasPais, DMConfig.EsLaFont, 'Listado de Ventas por País', '');
  ...
  ConfigurarOpcion(  mnuSalFacturasAlbaran, DMConfig.EsLaFont, 'Listado Facturas Albarán', '');
  ConfigurarOpcion(  mnuSalSalidasFactura, DMConfig.EsLaFont , 'Listado Salidas por Número de Factura', '');
  ...
  ConfigurarOpcion(  mnuSalPromedioVentasProduccion, DMConfig.EsLaFont, 'Promedio Ventas Neto Producción', '');
...
begin
  ...
  ConfigurarOpcion(  mnuFacNotificacionCredito, bPuedoFacturar, 'Notificación de Crédito', '');
...
begin
  ...
  ConfigurarOpcion(  mnuDatTransitos, True, 'Tránsitos', '');
  ...
  ConfigurarOpcion(  mnuDatCosteEnvase, True, 'Coste Artículos', '');
end;
