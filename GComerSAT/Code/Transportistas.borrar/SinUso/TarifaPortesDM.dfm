object DMTarifaPortes: TDMTarifaPortes
  ...
  object QMaestro: TQuery
    ...
    object QMaestrototal_csp: TFloatField
      FieldName = 'total_csp'
      Origin = 'COMERCIALIZACION.frf_cost_portes.total_csp'
    end
    object QMaestroparcial_csp: TFloatField
      FieldName = 'parcial_csp'
      Origin = 'COMERCIALIZACION.frf_cost_portes.parcial_csp'
    end
  end
