object QREscandallosVsAjustes: TQREscandallosVsAjustes
  Left = 0
  Top = 0
  Width = 1123
  Height = 794
  ...
  DataSet = DMAprovecha.QAprovechaDiario
  ...
  object DetailBand1: TQRBand
    ...
    object QRExpr4: TQRExpr
      ...
      WordWrap = True
      Expression = 
        '[kilos]-([kilos_esc_segunda]+[kilos_esc_tercera]+[kilos_esc_dest' +
        'rio])'
      Mask = '#,##0.00'
      FontSize = 9
    end
  ...
  object CabProducto: TQRGroup
    ...
    PreCaluculateBandHeight = False
    KeepOnOnePage = False
    Expression = '[esdel_grupo]+[producto_e]+[tipo]'
  ...
  object CabCosechero: TQRGroup
    ...
    PreCaluculateBandHeight = False
    KeepOnOnePage = False
    Expression = '[esdel_grupo]+[producto_e]+[cosechero_e]+[tipo]'
  ...
  object PieCosechero: TQRBand
    ...
    object QRExpr12: TQRExpr
      ...
      WordWrap = True
      Expression = 
        'sum([kilos]-([kilos_esc_segunda]+[kilos_esc_tercera]+[kilos_esc_' +
        'destrio]))'
      Mask = '#,##0.00'
      FontSize = 9
    end
    object QRExpr13: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum([kilos_esc_segunda])'
      Mask = '#,##0.00'
      FontSize = 9
    end
    object QRExpr14: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum([kilos_esc_tercera])'
      Mask = '#,##0.00'
      FontSize = 9
    end
    object QRExpr15: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'sum([kilos_esc_destrio])'
      Mask = '#,##0.00'
      FontSize = 9
    end
