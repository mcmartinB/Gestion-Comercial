...
begin
  ...
  if Trim( AParametros.sCliente ) <> '' then
  begin
    sCadena.Add( ' and cliente_sal_sc = ' + QuotedStr( AParametros.sCliente ));
  end
  else
  begin
    sCadena.Add('and cliente_sal_sc not in (''RET'',''REA'',''EG'', ''REP'')  and cliente_fac_sc[1,1] <> ''0'' ');
  end;
