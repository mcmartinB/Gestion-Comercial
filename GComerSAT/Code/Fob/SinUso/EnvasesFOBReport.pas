...
begin
  ...
  lblImporteDetalle.Caption:= FormatFloat( '#,##0.00', importe );
  lblGastosDetalle.Caption:= FormatFloat( '#,##0.00', gastos );
  lblNetoDetalle.Caption:= FormatFloat( '#,##0.00', importe - gastos );
  if kilos <> 0  then
