object QLVentasFobCliente: TQLVentasFobCliente
  Left = 0
  Top = 0
  Width = 794
  Height = 1123
  ...
  DataSet = DLVentasFobCliente.mtListado
  ...
  PrintIfEmpty = True
  ReportTitle = 'FOB Facturacion Clientes'
  SnapToGrid = True
  Units = Pixels
  Zoom = 100
  ...
  object BandaDetalle: TQRBand
    ...
    object qrx9: TQRExpr
      ...
      WordWrap = True
      Expression = 
        'IF([peso]=0,0,([importe]-([gasto_albaran]+[coste_envase]))/[peso' +
        '])'
      Mask = '#,##0.000'
      FontSize = 8
    end
    object qrx15: TQRExpr
      ...
      Transparent = True
      WordWrap = True
      Expression = '[importe]-([gasto_albaran]+[coste_envase])'
      Mask = '#,##0.00'
      FontSize = 8
    end
  ...
  object QRBand5: TQRBand
    ...
    object LPeriodoFacturas: TQRLabel
      Left = 448
      Top = 65
      Width = 270
      Height = 17
    ...
    object PsQRLabel25: TQRLabel
      ...
      AutoSize = True
      AutoStretch = False
      Caption = 'FOB FACTURACI'#211'N CLIENTES'
      Color = clWhite
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -24
  ...
  object SummaryBand1: TQRBand
    ...
    object qrx16: TQRExpr
      ...
      Transparent = True
      WordWrap = True
      Expression = 'sum([importe]-([gasto_albaran]+[coste_envase]))'
      Mask = '#,##0.00'
      FontSize = 8
    end
    object qrx13: TQRExpr
      ...
      WordWrap = True
      Expression = 
        'IF(sum([peso])=0,0,(sum([importe])-(sum([gasto_albaran]+[coste_e' +
        'nvase])))/sum([peso]))'
      Mask = '#,##0.000'
      FontSize = 8
    end
  ...
  object qrgCategoria: TQRGroup
    ...
    FooterBand = bndPieCategoria
    Master = Owner
    ReprintOnNewPage = False
  end
  object bndPieCategoria: TQRBand
    Left = 38
    Top = 189
    Width = 718
    Height = 21
