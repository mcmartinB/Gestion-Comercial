...
begin
  ...
  QLSalidasSuministro.qrlSuministro.Caption:= AParametros.sCliente + ' - ' + desCliente( AParametros.sCliente );
  if AParametros.sSuministro <> '' then
  begin
    QLSalidasSuministro.qrlSuministro.Caption:= desSuministro( AParametros.sEmpresa,
  ...
  PonLogoGrupoBonnysa( QLSalidasSuministro, AParametros.sEmpresa );
