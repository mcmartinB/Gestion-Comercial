...
begin
  ...
  begin
    ShowMessage(' ATENCION! No se puede borrar un depósito con número de entrada LAME asignado. ');
    exit;
  end;
...
begin
  ...
  begin
    ShowMessage(' ATENCION! No se puede cancelar la asignacion de LAME porque no es el último numero. ');
    exit;
  end;
