...
begin
  ...
  // 2º Buscamos en albaranes de venta, una linea que contenga todos los kilos del transito, para que tengamos 1 transito --> 1 factura
  // 3º Buscamos en albaranes de venta, en muchas lineas hasta conseguir todos los kilos del transito
