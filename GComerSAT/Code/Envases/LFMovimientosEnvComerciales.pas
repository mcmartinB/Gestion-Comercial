...
begin
  ...
  begin
    ...
    begin
      ...
      SQL.Add('select empresa_ect empresa, centro_destino_ect centro, cod_operador_ect operador, cod_producto_ect producto,  ');
    ...
    begin
      ...
      SQL.Add('select empresa_tl empresa, centro_destino_tl centro, env_comer_operador_e operador, env_comer_producto_e producto,  ');
      SQL.Add('       4 tipo, fecha_tl fecha, '''' cliente, centro_tl almacen, sum(cajas_tl) cantidad, 0 stock,  ');
      ...
      SQL.Add('select empresa_tl empresa, centro_destino_tl centro, env_comer_operador_tp operador, env_comer_producto_tp producto,  ');
      SQL.Add('       4 tipo, fecha_tl fecha, '''' cliente, centro_tl almacen, sum(palets_tl) cantidad, 0 stock,  ');
    ...
    begin
      ...
      SQL.Add('select empresa_tl empresa, centro_tl centro, env_comer_operador_e operador, env_comer_producto_e producto,  ');
      SQL.Add('       7 tipo, fecha_tl fecha, '''' cliente, centro_destino_tl almacen, sum(cajas_tl * -1) cantidad, 0 stock,  ');
      ...
      SQL.Add('select empresa_tl empresa, centro_tl centro, env_comer_operador_tp operador, env_comer_producto_tp producto,  ');
      SQL.Add('       7 tipo, fecha_tl fecha, '''' cliente, centro_destino_tl almacen, sum(palets_tl * -1) cantidad, 0 stock,  ');
