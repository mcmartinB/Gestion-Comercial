...
procedure TQREntregas.bndCabEntradasBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  PrintBand:= not MDEntregas.TListEntregasRel.IsEmpty;
end;

procedure TQREntregas.bndEntradasBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  PrintBand:= not MDEntregas.TEntregasRel.IsEmpty;
end;

procedure TQREntregas.QRDBText9Print(sender: TObject; var Value: String);
begin
...
procedure TQREntregas.QRDBText16Print(sender: TObject; var Value: String);
begin
...
procedure TQREntregas.QRDBText22Print(sender: TObject; var Value: String);
begin
