...
begin
  ...
  try
    ...
    if not CosteFrutaProductoQL.VerListadoStock( self, Trim(eEmpresa.Text), Trim(eCentro.Text),
      Trim(eProducto.Text), Trim(eProveedor.Text), Trim(eEntrega.Text), eTipoGasto.Text, chkImporteFruta.checked,
...
procedure TFLCosteFrutaProducto.cbxVariedadClick(Sender: TObject);
begin
...
procedure TFLCosteFrutaProducto.eTipoGastoChange(Sender: TObject);
begin
