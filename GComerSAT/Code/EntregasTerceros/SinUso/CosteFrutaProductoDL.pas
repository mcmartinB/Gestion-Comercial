...
function TDLCosteFrutaProducto.DatosQueryFrutaProveedor( const AEmpresa, ACentro, AProducto, AProveedor, AEntrega, ATipoGasto: string;
                                                         const AMasImporte: Boolean; const AFechaDesde, AFechaHasta: string;
                                                         const AAgruparVariedad, AAgruparCalibre: Boolean; AMensaje: TLabel ): boolean;
begin
...
procedure TDLCosteFrutaProducto.RellenarTablaDeGastos( const ATipoGasto: string; const AMasImporte: Boolean; AMensaje: TLabel );
var
...
procedure TDLCosteFrutaProducto.ObtenerGastos( const AEntrega, AProducto, AVariedad, ACalibre, ATipoGasto: string; const AMasImporte: Boolean;
                                             var AKilosCal, AKilosTot, AImporteLinea, AFacturas, AGastos: real );
begin
...
procedure TDLCosteFrutaProducto.ObtenerGastosEx( const AEntrega, AProducto, AVariedad, ACalibre, ATipoGasto: string; const AMasImporte: Boolean;
                                               var AKilosCal, AKilosTot, AImporteLinea, AFacturas, AGastos: real );
begin
  with QGastos do
  begin
