...
begin
  ...
  begin
    SQL.Clear;
    SQL.Add('select tipo_gc, producto_gc, ref_fac_gc, fecha_fac_gc, nota_gc, importe_gc ');
    ...
    SQL.Add('order by tipo_gc, producto_gc, ref_fac_gc ');
    Prepare;
  end;
  ...
  begin
    SQL.Clear;
    SQL.Add('  select codigo_ge, tipo_ge, producto_ge, ref_fac_ge, fecha_fac_ge, nota_ge, importe_ge ');
    ...
    SQL.Add('order by codigo_ge, tipo_ge, producto_ge, ref_fac_ge ');
    Prepare;
  end;
end;
