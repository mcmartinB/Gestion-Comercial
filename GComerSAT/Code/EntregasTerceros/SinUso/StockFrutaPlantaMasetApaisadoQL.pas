...
begin
  ...
  try
    QLStockFrutaPlantaMasetApaisado.PreparaListado( AEmpresa, ACentro, AProducto, ASemana, AEntrega, '',
...
begin
  QLStockFrutaPlantaMasetApaisado:= TQLStockFrutaPlantaMasetApaisado.Create( AOwner );
  try
    QLStockFrutaPlantaMasetApaisado.PreparaListado( AEmpresa, ACentro, '', '', '', DateToStr( AFechaIni ),
...
procedure TQLStockFrutaPlantaMasetApaisado.PreparaListado( const AEmpresa, ACentro, AProducto, ASemana, AEntrega, AFecha: string;
                                                   const AProveedor, Variedad, ACalibre, APais, AFechaIni, AFechaFin: string );
begin
