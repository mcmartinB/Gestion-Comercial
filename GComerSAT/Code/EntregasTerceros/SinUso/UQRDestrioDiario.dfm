object QRDestrioDiario: TQRDestrioDiario
  Left = 0
  Top = 0
  Width = 794
  Height = 1123
  ...
  object DetailBand1: TQRBand
    ...
    object unidad_de: TQRDBText
      ...
      DataSet = DMBaseDatos.QListado
      DataField = 'unidad_de'
      OnPrint = unidad_dePrint
      Transparent = True
      WordWrap = True
      FontSize = 8
    end
    object porcentaje_de: TQRDBText
      Left = 478
      Top = 1
      Width = 38
      Height = 17
  ...
  object QRGroup1: TQRGroup
    ...
    PreCaluculateBandHeight = False
    KeepOnOnePage = False
    Expression = '[empresa_de] + [centro_de] + [producto_de] '
    Master = Owner
