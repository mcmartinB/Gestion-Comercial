...
begin
  ...
  try
    ...
    case AEstado of
      ...
      2:QLEntregasPendientes.lblTitulo.Caption:= 'ENTREGAS DESCARGADAS Y PENDIENTES';
    end;
...
begin
  ...
  try
    result:= DLEntregasPendientes.DatosQueryEntregasPendientes( AEmpresa, ACentro, AProducto, AFechaIni, AFechaFin, AEstado );
    if result then
    begin
      VerListadoEntregasPendientesEx( AOwner, AEmpresa, ACentro, AProducto, AFechaIni, AFechaFin, AEstado );
    end;
  finally
