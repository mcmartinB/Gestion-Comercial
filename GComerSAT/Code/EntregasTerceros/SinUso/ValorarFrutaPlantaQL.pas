...
type
  ...
  public
    ...
    procedure PreparaListado( const AEmpresa, ACentro, AProducto, AEntregaDesde, AEntregaHasta: string );
  end;

  function VerListadoStock( const AOwner: TComponent;
                            const AEmpresa, ACentro, AProducto, AEntregaDesde, AEntregaHasta: string;
...
begin
  ...
  try
    QLValorarFrutaPlanta.PreparaListado( AEmpresa, ACentro, AProducto, AEntregaDesde, AEntregaHasta );
...
begin
  ...
  try
    result:= DLValorarFrutaPlanta.DatosQueryStock( AEmpresa, ACentro, AProducto, AEntregaDesde, AEntregaHasta );
    if result then
    begin
      VerListadoStockEx( AOwner, AEmpresa, ACentro, AProducto, AEntregaDesde, AEntregaHasta, AAgruparVariedad, AAgruparCalibre );
    end;
  finally
...
procedure TQLValorarFrutaPlanta.PreparaListado( const AEmpresa, ACentro, AProducto, AEntregaDesde, AEntregaHasta: string );
begin
