...
begin
  ...
  try
    ...
    begin
      ...
      SQL.Add(' group by proveedor_ec, almacen_ec, codigo_ec, vehiculo_ec, albaran_ec ');
      SQL.Add(' order by proveedor_ec, almacen_ec, codigo_ec ');
...
procedure TFLResumenEntregasMaset.cbxCentroChange(Sender: TObject);
begin
  if cbxCentro.ItemIndex = 0 then
  begin
