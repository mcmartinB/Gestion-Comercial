object FMGastosCompras: TFMGastosCompras
  Left = 285
  Top = 202
  ...
  object PRejilla: TPanel
    ...
    object btnFecha_fac_gc: TBCalendarButton
      Left = 608
      Top = 76
      Width = 12
      Height = 21
      ...
      OnClick = btnFecha_fac_gcClick
      Control = fecha_fac_gc
      Calendar = Calendario
    ...
    object tipo_gc: TBDEdit
      ...
      Zeros = True
      Required = True
      OnRequiredTime = tipo_gcRequiredTime
      MaxLength = 3
      TabOrder = 1
      OnChange = tipo_gcChange
      DataField = 'tipo_gc'
      DataSource = DSGastosCompras
      Modificable = False
      PrimaryKey = True
    end
    object importe_gc: TBDEdit
      Left = 344
      Top = 52
      Width = 86
      Height = 21
  ...
  object DSGastosCompras: TDataSource
    DataSet = QGastosCompras
    Left = 40
    Top = 72
  end
  object QGastosCompras: TQuery
    AfterPost = QGastosComprasAfterPost
    AfterDelete = QGastosComprasAfterDelete
