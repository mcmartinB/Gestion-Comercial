object FLEntregasSinFacturar: TFLEntregasSinFacturar
  Left = 573
  Top = 210
  ActiveControl = eEmpresa
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = '    ENTREGAS PROVEEDOR SIN FACTURAR'
  ClientHeight = 220
  ClientWidth = 347
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object lbl1: TLabel
      ...
      Width = 257
      Height = 13
      Caption = 'Lista las entregas que no tienen grabado el gasto '#39'110'#39
    end
  ...
  object QEntregasSinFacturar: TQuery
