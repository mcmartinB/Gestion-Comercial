object QRDetalleLiquidacionFruta: TQRDetalleLiquidacionFruta
  Left = 0
  Top = 0
  Width = 1123
  Height = 794
  ...
  DataSet = DMDetalleLiquidacionFruta.qryListado
  ...
  PrintIfEmpty = True
  ReportTitle = 'Detalle_Liquidacion_Fruta'
  SnapToGrid = True
  Units = MM
  Zoom = 100
  ...
  object CabeceraPagina: TQRBand
    ...
    object QRLabel1: TQRLabel
      ...
      AutoSize = True
      AutoStretch = False
      Caption = 'DETALLE LIQUIDACI'#211'N FRUTA'
      Color = clWhite
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -24
  ...
  object qrbndDetailBand1: TQRBand
    ...
    object qrxpr7: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = '[importe]-([descuento]+[gasto]+[abono])'
      Mask = '#,##0.00'
      FontSize = 8
    end
    object qrxpr8: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = '[importe]-([descuento]+[gasto]+[abono]+[envasado])'
      Mask = '#,##0.00'
      FontSize = 8
    end
    ...
    object qrxpr19: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = '[importe]-([descuento]+[gasto]+[abono]+[envasado]+[gestion])'
      Mask = '#,##0.00'
      FontSize = 8
    end
    ...
    object qrxpr20: TQRExpr
      ...
      WordWrap = True
      Expression = 
        'IF([kilos]<>0,([importe]-([descuento]+[gasto]+[abono]+[envasado]' +
        '+[gestion])) / [kilos],0)'
      Mask = '#,##0.000'
      FontSize = 8
    end
  ...
  object qrgrpCosechero: TQRGroup
    ...
    object qrdbtxtcosechero1: TQRDBText
      ...
      Font.Name = 'Arial'
      Font.Style = []
      OnPrint = qrdbtxtcosechero1Print
      ParentFont = False
      Transparent = False
      WordWrap = True
      FontSize = 9
  ...
  object qrgrPlantacion: TQRGroup
    Left = 37
    Top = 160
    Width = 1048
    Height = 21
    ...
    Frame.DrawRight = False
    AlignToBottom = False
    BeforePrint = qrgrPlantacionBeforePrint
    Color = clWhite
    TransparentBand = False
    ForceNewColumn = False
    ForceNewPage = False
    ...
    PreCaluculateBandHeight = False
    KeepOnOnePage = False
    Expression = '[empresa]+[origen]+[producto]+[cosechero]+[plantacion]'
  ...
  object qrbndPieCosechero: TQRBand
    ...
    object qrxpr22: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'SUM([importe]-([descuento]+[gasto]+[abono]))'
      Mask = '#,##0.00'
      FontSize = 8
    end
    object qrxpr23: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'SUM([importe]-([descuento]+[gasto]+[abono]+[envasado]))'
      Mask = '#,##0.00'
      FontSize = 8
    end
    object qrxpr24: TQRExpr
      ...
      WordWrap = True
      Expression = 
        'SUM([importe]-([descuento]+[gasto]+[abono]+[envasado]+[gestion])' +
        ')'
      Mask = '#,##0.00'
      FontSize = 8
    end
    object qrxpr25: TQRExpr
      ...
      WordWrap = True
      Expression = 
        'IF([kilos]<>0,SUM(([importe]-([descuento]+[gasto]+[abono]+[envas' +
        'ado]+[gestion]))) / SUM([kilos]),0)'
      Mask = '#,##0.000'
      FontSize = 8
    end
