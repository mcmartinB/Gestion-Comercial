object DMLAsignacionFederaciones: TDMLAsignacionFederaciones
  ...
  object qryAlbaranesPorAsignar: TQuery
    DatabaseName = 'BDProyecto'
    SQL.Strings = (
  ...
  object qryAsignarSalida: TQuery
    DatabaseName = 'BDProyecto'
    SQL.Strings = (
  ...
  object qryAsignarTransito: TQuery
    DatabaseName = 'BDProyecto'
    SQL.Strings = (
