...
uses uDMConfig, DPreview, UDMAuxDB;
...
procedure TQMCartaPorte.QRDBText9Print(sender: TObject; var Value: String);
begin
  Value:= 'ESPAÑA';
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      saux:= desProductoBase( dmDatos.QAlbaranCab.FieldByName('empresa_sc').AsString, sAux );
      qrmProductos.Lines.Add( sAux );

      sAux:= dmDatos.QAlbaranLin.FieldByName('envase').AsString;
      saux:= desEnvase( dmDatos.QAlbaranCab.FieldByName('empresa_sc').AsString, sAux );
