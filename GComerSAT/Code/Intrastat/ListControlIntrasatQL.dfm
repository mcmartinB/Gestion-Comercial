object QLListControlIntrasat: TQLListControlIntrasat
  Left = 0
  Top = 0
  Width = 1123
  Height = 794
  ...
  DataSet = DLListControlIntrasat.QListControlIntrasat
  ...
  object bndTitulo: TQRBand
    ...
    object lblRangoFechas: TQRLabel
      ...
      AutoSize = True
      AutoStretch = False
      Caption = 'Del xx/xx/xxxx al yy/yy/yyyy'
      Color = clWhite
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
  ...
  object QRGroup3: TQRGroup
    ...
    PreCaluculateBandHeight = False
    KeepOnOnePage = False
    Expression = '[centro]+[comunitario]+[pais]'
    FooterBand = QRBand4
    Master = Owner
    ReprintOnNewPage = False
  ...
  object QRGroup4: TQRGroup
    ...
    PreCaluculateBandHeight = False
    KeepOnOnePage = False
    Expression = '[centro]+[comunitario]+[pais]+[estomate]'
    FooterBand = QRBand5
    Master = Owner
    ReprintOnNewPage = False
  ...
  object QRGroup5: TQRGroup
    ...
    PreCaluculateBandHeight = False
    KeepOnOnePage = False
    Expression = '[centro]+[comunitario]+[pais]+[estomate]+[producto]'
    FooterBand = QRBand6
    Master = Owner
    ReprintOnNewPage = False
