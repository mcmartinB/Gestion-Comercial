...
begin
  ...
  begin
    ...
    SQL.Add('       Max( (select nombre_c from frf_clientes where empresa_c = empresa_ce and cliente_c = cliente_ce) ) nombre_ce ');
  ...
  begin
    ...
    SQL.Add('        Max( ( select nombre_ds from frf_dir_sum where empresa_ds = empresa_ce ');
  ...
  begin
    ...
    SQL.Add('and empresa_ce = empresa_e ');
    SQL.Add('and producto_base_ce = producto_base_e ');
  ...
  *)
  ...
  begin
    ...
    SQL.Add('                                         where empresa_p = :empresa_ecr and producto_p = producto_sl ) ), ');
    SQL.Add('            ( select descripcion_e from frf_envases ');
    SQL.Add('              where empresa_e = :empresa_ecr  and envase_e = envase_sl and producto_base_e = ( select producto_base_p from frf_productos ');
    SQL.Add('                                         where empresa_p = :empresa_ecr and producto_p = producto_sl ) ) )descripcion, ');

    SQL.Add('         nvl( ( select unidad_fac_ce from frf_clientes_env ');
    SQL.Add('           where empresa_ce = :empresa_ecr and cliente_ce = cliente_sl ');
    SQL.Add('             and envase_ce = envase_sl and producto_base_ce = ( select producto_base_p from frf_productos ');
    SQL.Add('                                         where empresa_p = :empresa_ecr and producto_p = producto_sl ) ), ''K'' ) unidad_factura, ');
