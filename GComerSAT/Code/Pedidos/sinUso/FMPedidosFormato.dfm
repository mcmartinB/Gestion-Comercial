object frmMPedidosFormato: TfrmMPedidosFormato
  ...
  object PDetalle: TPanel
    ...
    object PDetalleEdit: TPanel
      ...
      object btnProductoBase: TBGridButton
        Left = 168
        Top = 12
        Width = 13
        Height = 22
      ...
      object producto_base_pdd: TBDEdit
        Tag = 1
        Left = 130
        Top = 13
        Width = 25
        ...
        MaxLength = 3
        TabOrder = 0
        OnChange = producto_base_pddChange
        DataField = 'producto_base_pdd'
        DataSource = DSDetalle
        PrimaryKey = True
      end
