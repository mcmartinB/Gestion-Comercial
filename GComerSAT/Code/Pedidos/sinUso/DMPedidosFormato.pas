...
type
  ...
  public
    ...
    procedure QueryListado( const AEmpresa, ACentro, ACliente, AProductoBase, APedido:string;
...
procedure TdtmMPedidosFormato.QueryListado( const AEmpresa, ACentro, ACliente, AProductoBase, APedido:string;
                                            const AFechaIni, AFechaFin: TDateTime  );
var
  iProducto: integer;
begin
  ...
  if TryStrToInt( AProductoBase, iProducto ) then
    QListado.SQL.Add(' and producto_base_pdd = :producto ')
  else
    iProducto:= -1;
  ...
  QListado.SQL.Add('        producto_base_pdd, formato_cliente_pdd, categoria_pdd, calibre_pdd, color_pdd ');
  ...
  if iProducto <> -1 then
    QListado.ParamByName('producto').AsInteger:= iProducto;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      SQL.Clear;
      SQL.Add(' select producto_f, envase_f, palet_f, n_cajas_f, ');
      ...
      SQL.Add(' and ( producto_base_e = :producto or producto_base_e is null ) ');
      ...
      SQL.Add(' and ( producto_base_ce = :producto or producto_base_ce is null ) ');
