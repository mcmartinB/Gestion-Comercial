object FLPedidosEnvase: TFLPedidosEnvase
  Left = 439
  Top = 253
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = '  PEDIDOS/SALIDAS POR ENVASES'
  ClientHeight = 317
  ClientWidth = 454
  Color = clBtnFace
  ...
  object lblInformacion: TLabel
    ...
    Width = 118
    Height = 13
    Caption = 'Mensajes de Informacion'
  end
  ...
  object cbxSinPedidos: TCheckBox
    Left = 144
    Top = 208
    Width = 251
    Height = 17
    Alignment = taLeftJustify
    Caption = 'A'#241'adir salidas sin un n'#250'mero de pedido grabado.'
    TabOrder = 13
  end
