...
type
  TQRLProducto = class(TQuickRep)
    ...
    procedure centro_ePrint(sender: TObject; var Value: string);
    procedure ejercicio_ePrint(sender: TObject; var Value: string);
    ...
    procedure codigo_pvPrint(sender: TObject; var Value: String);
    procedure descripcion_pvPrint(sender: TObject; var Value: String);
  private
...
begin
  ...
  if not CalibreDataSet.Active and
    ...
    not EjercicioDataSet.Active then begin
...
begin
  MoreData := not (CalibreDataSet.EOF and
    ...
    EjercicioDataSet.EOF);
{
  if CalibreDataSet.EOF and
     CategoriaDataSet.EOF and
     ColorDataSet.EOF and
     EjercicioDataSet.EOF then
     MoreData:=False
  else
     MoreData:=True;
}
...
procedure TQRLProducto.centro_ePrint(sender: TObject; var Value: string);
begin
...
procedure TQRLProducto.ejercicio_ePrint(sender: TObject;
  var Value: string);
begin
  if not EjercicioDataSet.EOF then
...
procedure TQRLProducto.codigo_pvPrint(sender: TObject; var Value: String);
begin
...
procedure TQRLProducto.descripcion_pvPrint(sender: TObject;
  var Value: String);
begin
  if not VariedadDataSet.EOF then
