...
type
  TQRLRemesas = class(TQuickRep)
    ...
    qrenotas_r: TQRDBText;
    qrl1: TQRLabel;
    qrlbl1: TQRLabel;
    empresa_fr: TQRDBText;
...
begin
  Value:= desCliente( QRDetalle.DataSet.FieldByname('empresa_fr').AsString,
...
procedure TQRLRemesas.qrl1Print(sender: TObject; var Value: String);
begin
  if Trim( qrenotas_r.DataSet.FieldByName('notas_r').AsString ) = '' then
  begin
    Value:= '';
  end;
end;
