object QRLClientes: TQRLClientes
  Left = 0
  Top = 0
  Width = 1123
  Height = 794
  ...
  object bndcNotas: TQRChildBand
    ...
    Frame.DrawRight = False
    AlignToBottom = False
    BeforePrint = bndcNotasBeforePrint
    Color = clWhite
    TransparentBand = False
    ForceNewColumn = False
    ForceNewPage = False
  ...
  object QDescripciones: TQuery
    ...
    SQL.Strings = (
      'SELECT  nombre_e, descripcion_p, descripcion_m, descripcion_r'
      'FROM frf_empresas, frf_paises, frf_monedas, frf_representantes'
      'WHERE     empresa_e = :empresa_c'
      'AND       pais_p = :pais_c'
