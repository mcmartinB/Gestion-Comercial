object QRLVentasFOB_tot: TQRLVentasFOB_tot
  Left = 0
  Top = 0
  Width = 794
  Height = 1123
  ...
  object SummaryBand1: TQRBand
    ...
    object PsQRExpr6: TQRExpr
      ...
      Transparent = False
      WordWrap = True
      Expression = 'SUM(importe_venta_tvf)'
      Mask = '#,##0.00'
      FontSize = 9
    end
