object RControlFob: TRControlFob
  Left = 0
  Top = 0
  Width = 794
  Height = 1123
  ...
  object PiePagina: TQRBand
    ...
    object lblCategorias: TQRLabel
      ...
      AutoStretch = False
      Caption = 
        'Solo se tiene en cuenta albaranes con categorias comerciales (1,' +
        '2 '#243' 3)'
      Color = clWhite
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
