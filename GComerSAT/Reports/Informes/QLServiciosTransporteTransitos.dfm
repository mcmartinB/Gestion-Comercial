object QRLServiciosTransporteTransitos: TQRLServiciosTransporteTransitos
  Left = 0
  Top = 0
  Width = 794
  Height = 1123
  ...
  DataSet = DMLServiciosTransporteTransitos.mtListado
  ...
  object SummaryBand1: TQRBand
    ...
    object QRExpr6: TQRExpr
      ...
      Transparent = True
      WordWrap = True
      Expression = 'IF(sum([kilos])=0,0,sum([coste])/sum([kilos]))'
      Mask = '#,##0.000'
      FontSize = 8
    end
  ...
  object detalle: TQRBand
    ...
    object qrxpr1: TQRExpr
      ...
      Transparent = True
      WordWrap = True
      Expression = 'IF([kilos]=0,0,[coste]/[kilos])'
      Mask = '#,##0.000'
      FontSize = 8
    end
    object qrxprmarca: TQRExpr
      Left = 5
      Top = 0
      Width = 58
      Height = 17
