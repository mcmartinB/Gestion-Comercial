...
begin
  ...
  try
    ...
    QRLCambioDivisas.dFechaIni:= DMBaseDatos.QListado.FieldByname('fecha_ce').AsDateTime;
    DMBaseDatos.QListado.Last;
    QRLCambioDivisas.dFechaFin:= DMBaseDatos.QListado.FieldByname('fecha_ce').AsDateTime;
