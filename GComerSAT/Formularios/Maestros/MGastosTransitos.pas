...
uses
  ...
  dxSkinFoggy, Menus, cxButtons, SimpleSearch, cxTextEdit, cxDBEdit,
  SimpleSearch2, dxSkinMoneyTwins, dxSkinBlack, dxSkinBlue, dxSkinCaramel,
...
type
  TFMGastosTransitos = class(TForm)
    ...
    procedure ssTransporteOldAntesEjecutar(Sender: TObject);
...
procedure TFMGastosTransitos.ssTransporteOldAntesEjecutar(Sender: TObject);
begin
  ssTransporte.SQLAdi := '';
  if sEmpresa <> '' then
    ssTransporte.SQLAdi := ' empresa_t = ' +  QuotedStr(sEmpresa);
