  ...
  object pgFactura: TPageControl
    ...
    object tsAbono: TTabSheet
      ...
      object pnlAbono: TPanel
        ...
        object cosechero_fal: TBDEdit
          Left = 426
          Top = 100
          Width = 31
          Height = 21
          Hint = 'Cosechero al que aplicar el abono. (Solo para liquidaciones)'
          ColorEdit = clMoneyGreen
          InputType = itInteger
          MaxLength = 3
          TabOrder = 11
          OnChange = PonNombreDetalle
          DataField = 'cosechero_fal'
          DataSource = DSDetalleAbono
        end
