  ...
  case TComponent(Sender).Tag of
    ...
    kProducto:
      begin
        ...
        if (Producto.Text = 'E') or (Producto.Text = 'T') then
        begin
    ...
    kCliente: STCliente.Caption := desCliente(Empresa.Text, Cliente.Text);
...
begin
  ...
  begin
    ...
    SQL.add(' and ( producto_sl = :producto1 or producto_sl = :producto2 ) ');
    if bCliente then
    begin
      if sListaCliente <> '' then
    ...
    ParamByName('empresa').AsString := Empresa.Text;
    if cbxTomate.Checked and ((Producto.Text = 'E') or (Producto.Text = 'T')) then
    begin
      ParamByName('producto1').AsString := 'T';
      ParamByName('producto2').AsString := 'E';
    end
    else
    begin
      ParamByName('producto1').AsString := Producto.Text;
      ParamByName('producto2').AsString := Producto.Text;
    end;
...
begin
  ...
  try
    ...
    if cbxTomate.Checked and ((Producto.Text = 'E') or (Producto.Text = 'T')) then
      DQLComSemVen.PsProducto.Caption := 'TE - TOMATE'
    else
    ...
    if bEnvase then
      ...
      DQLComSemVen.lblEnvase.Caption := 'TODOS LOS ENVASES';
    if bCentro then
    begin
      if bCentroOrigen then
    ...
    begin
      if bPais then
        ...
        DQLComSemVen.PsCliente.Caption := Cliente.Text + ' - ' + DesCliente(Empresa.Text, Cliente.Text)
    end
    else
