...
begin
  ...
  if eCentroSalida.Text = '' then
    QRLServiciosTransporteEntregas.lblCentro.Caption:=  'CENTRO SALIDA: TODOS'
  else
    QRLServiciosTransporteEntregas.lblCentro.Caption:=  'CENTRO SALIDA: ' + eCentroSalida.Text + ' ' + stCentroSalida.Caption;
  (*TODO*)
...
begin
  ...
  begin
    try
      if DMLServiciosTransporteEntregas.ObtenerDatos( sEmpresa, sCentroSalida, sCentroLlegada,
...
procedure TFLServiciosTransporteEntregas.DesCentroSalidaOptativo;
begin
  if eCentroSalida.Text = '' then
  begin
...
procedure TFLServiciosTransporteEntregas.eCentroSalidaChange(Sender: TObject);
begin
  DesCentroSalidaOptativo;
end;
