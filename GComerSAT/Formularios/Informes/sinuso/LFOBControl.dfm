object FLFOBControl: TFLFOBControl
  Left = 298
  Top = 208
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = '  LISTADOS CONTROL'
  ClientHeight = 242
  ClientWidth = 436
  Color = clBtnFace
  ...
  object lblEspere2: TLabel
    ...
    Width = 279
    Height = 13
    Caption = '(ESTE PROCESO PUEDE DURAR VARIOS MINUTOS)'
    Font.Charset = ANSI_CHARSET
    Font.Color = clMaroon
    Font.Height = -11
    Font.Name = 'Arial'
  ...
  object cbxTipoListado: TComboBox
    ...
    ItemIndex = 0
    TabOrder = 9
    Text = 'Todos los Albaranes'
    Items.Strings = (
      'Todos los Albaranes'
      'Albaranes sin Precio'
      'Albaranes Pendientes de Facturar'
      'Todos los Tr'#225'nsitos'
      'Tr'#225'nsitos Pendientes de Venta')
  end
