...
begin
    ...
    qryCliente.SQL.Add(' nombre_ds, nif_ds, tipo_via_ds, domicilio_ds, cod_postal_ds, poblacion_ds, pais_ds ');
    qryCliente.SQL.Add(' from frf_clientes ');
    qryCliente.SQL.Add('      join frf_dir_sum on empresa_ds = empresa_c and cliente_ds = cliente_c ');
    qryCliente.SQL.Add(' where empresa_c = :empresa ');
    qryCliente.SQL.Add(' and cliente_c = :cliente ');
...
begin
  ...
  qryCliente.ParamByName('empresa').AsString:= sEmpresa;
