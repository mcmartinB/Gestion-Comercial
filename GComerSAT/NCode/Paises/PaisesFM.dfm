object FMPaises: TFMPaises
  ...
  object PMaestro: TPanel
    ...
    object lblFob2: TLabel
      Left = 183
      Top = 128
      Width = 162
      Height = 19
      AutoSize = False
      Caption = 'Coste EUR/KG Plataforma Frigo. '
      Color = cl3DLight
      ParentColor = False
      Layout = tlCenter
    end
    ...
    object fob_plataforma_p: TBDEdit
      Tag = 1
      Left = 140
      Top = 127
      Width = 39
  ...
  object gridMaestro: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'fob_plataforma_p'
        Title.Caption = 'Coste FOB '#8364'/Kg.'
        Width = 89
        Visible = True
      end>
  end
