...
type
  TFPPaletsConfeccionado = class(TForm)
...
procedure TFPPaletsConfeccionado.FormCreate(Sender: TObject);
begin
  FormType := tfOther;
  BHFormulario;
...
procedure TFPPaletsConfeccionado.FormClose(Sender: TObject;
...
procedure TFPPaletsConfeccionado.FormKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
    vk_escape:
...
procedure TFPPaletsConfeccionado.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFPPaletsConfeccionado.btnCancelarClick(Sender: TObject);
begin
  Close;
end;

function TFPPaletsConfeccionado.ValidarEntrada: Boolean;
begin
  result := false;
...
procedure TFPPaletsConfeccionado.Ejecutar;
var
...
procedure TFPPaletsConfeccionado.btnAceptarClick(Sender: TObject);
begin
  Ejecutar;
end;

procedure TFPPaletsConfeccionado.eEmpresaChange(Sender: TObject);
begin
  etqEmpresa.Caption:= desEmpresa(eEmpresa.Text);
end;

procedure TFPPaletsConfeccionado.eCentroChange(Sender: TObject);
begin
  etqCentro.Caption:= desCentro(eEmpresa.Text, eCentro.Text);
end;


function TFPPaletsConfeccionado.eCentroGetSQL: String;
begin
