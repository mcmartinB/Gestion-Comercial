...
begin
  ...
  begin
    sEmpresa:= '050';                     //Se facturará todo a la 050 desde 01/01/2019
  end
  else
  begin
    sEmpresa:= AEmpresa;
...
begin
  ...
  sAsunto := 'Envío de ' + IntToStr(DFactura.mtFacturas_Cab.RecordCount) + ' Factura/s para el cliente ' + DFactura.mtFacturas_Cab.FieldByName('cod_cliente_fc').asString;
