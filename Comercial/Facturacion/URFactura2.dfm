object RFactura2: TRFactura2
  ...
  DataSet = DFactura.mtFacturas_Cab2
  ...
  object PiePagina: TQRBand
    ...
    object qrmResponsabilidadEnvase: TQRMemo
      Left = 12
      Top = 25
      Width = 700
      Height = 37
  ...
  object CabeceraFactura2: TQRChildBand
    ...
    object qlDesCliente2: TQRDBText
      Left = 32
      Top = 69
      Width = 300
      Height = 17
    ...
    object qrlblClienteOnline1: TQRLabel
      Left = 32
      Top = 198
      Width = 276
      Height = 15
  ...
  object CabeceraFactura: TQRGroup
    ...
    PreCaluculateBandHeight = False
    KeepOnOnePage = False
    Expression = 'cod_empresa_fac_fc + '#39'/'#39' + n_factura_fc + '#39'/'#39' + fecha_factura_fc'
  ...
  object BandaLinea: TQRSubDetail
    ...
    KeepOnOnePage = False
    Master = Owner
    DataSet = DFactura.mtFacturas_Det2
    PrintBefore = False
    PrintIfEmpty = False
    ...
    object Unidad: TQRDBText
      ...
      Color = clWhite
      DataSet = DFactura.mtFacturas_Det2
      DataField = 'unidad_facturacion_fd'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -12
      Font.Name = 'Arial'
    ...
    object qretipo_iva_tf: TQRDBText
      ...
      Color = clWhite
      DataSet = DFactura.mtFacturas_Det2
      DataField = 'porcentaje_impuesto_fd'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Arial'
  ...
  object BandaTotales: TQRBand
    ...
    object qrshpTotalEur1: TQRShape
      Left = 468
      Top = 113
      Width = 90
      Height = 23
    ...
    object qrTotalBaseEur: TQRLabel
      Left = 477
      Top = 119
      Width = 78
      Height = 16
    ...
    object qrshpTotalEur2: TQRShape
      Left = 558
      Top = 113
      Width = 70
      Height = 23
    ...
    object qrshpTotalEur3: TQRShape
      Left = 628
      Top = 113
      Width = 90
      Height = 23
  ...
  object bndPieAlbaran: TQRBand
    ...
    object qrsCostePlataforma5: TQRShape
      Left = 601
      Top = 0
      Width = 3
      Height = 17
  ...
  object CabeceraLinea: TQRChildBand
    ...
    object qrlProducto2: TQRLabel
      ...
      Font.Name = 'Times New Roman'
      Font.Style = [fsBold]
      OnPrint = qrlProducto2Print
      ParentFont = False
      Transparent = True
      WordWrap = True
      FontSize = 8
    end
    object qrlCantidad2: TQRLabel
      Left = 466
      Top = 15
      Width = 24
      Height = 16
      ...
      Font.Name = 'Times New Roman'
      Font.Style = [fsBold]
      OnPrint = qrlCantidad2Print
      ParentFont = False
      Transparent = True
      WordWrap = True
      FontSize = 8
    end
    object qrlUnidad2: TQRLabel
      Left = 515
      Top = 15
      Width = 27
      Height = 16
      ...
      Font.Name = 'Times New Roman'
      Font.Style = [fsBold]
      OnPrint = qrlUnidad2Print
      ParentFont = False
      Transparent = True
      WordWrap = True
      FontSize = 8
    end
    object qrlPrecio2: TQRLabel
      Left = 562
      Top = 15
      Width = 28
      Height = 16
  ...
  object bndEurosKg: TQRSubDetail
    Left = 53
    Top = 752
    Width = 718
    Height = 16
    ...
    Frame.DrawLeft = True
    Frame.DrawRight = True
    AfterPrint = bndEurosKgAfterPrint
    AlignToBottom = False
    BeforePrint = bndEurosKgBeforePrint
    Color = clWhite
    TransparentBand = False
    ForceNewColumn = False
    ForceNewPage = False
    ...
    object euroskg_importe: TQRDBText
      Left = 605
      Top = 0
      Width = 83
      Height = 17
  ...
  object bndComision: TQRSubDetail
    Left = 53
    Top = 768
    Width = 718
    Height = 16
    ...
    AlignToBottom = False
    BeforePrint = bndComisionBeforePrint
    Color = clWhite
    TransparentBand = False
    ForceNewColumn = False
    ForceNewPage = False
    ...
    object comision_imp_base: TQRDBText
      Left = 512
      Top = 0
      Width = 88
      Height = 17
    ...
    object comision_importe: TQRDBText
      Left = 605
      Top = 0
      Width = 83
      Height = 17
  ...
  object bndDescuento: TQRSubDetail
    Left = 53
    Top = 784
    Width = 718
    Height = 16
    ...
    AlignToBottom = False
    BeforePrint = bndDescuentoBeforePrint
    Color = clWhite
    TransparentBand = False
    ForceNewColumn = False
    ForceNewPage = False
    ...
    object lblDescuentoUK: TQRLabel
      Left = 356
      Top = 0
      Width = 108
      Height = 17
    ...
    object descuento_imp_base: TQRDBText
      Left = 512
      Top = 0
      Width = 88
      Height = 17
    ...
    object descuento_importe: TQRDBText
      Left = 605
      Top = 0
      Width = 83
      Height = 17
  ...
  object BandaGastos: TQRSubDetail
    ...
    KeepOnOnePage = False
    Master = Owner
    DataSet = DFactura.mtFacturas_Gas2
    PrintBefore = False
    PrintIfEmpty = False
    object qs1: TQRShape
      Left = 601
    ...
    object fecha_albaran_fg: TQRDBText
      Left = 78
      Top = 0
      Width = 72
      Height = 17
    ...
    object des_tipo_gasto_fg: TQRDBText
      Left = 163
      Top = 0
      Width = 412
      Height = 17
    ...
    object importe_neto_fg: TQRDBText
      Left = 605
      Top = 0
      Width = 83
      Height = 17
    ...
    object porcentaje_impuesto_fg: TQRDBText
      Left = 692
      Top = 0
      Width = 22
      Height = 17
      ...
      Color = clWhite
      DataSet = DFactura.mtFacturas_Gas2
      DataField = 'porcentaje_impuesto_fg'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Arial'
