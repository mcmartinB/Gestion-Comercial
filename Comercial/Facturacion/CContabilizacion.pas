...
begin
    ...
    try
      if bAuto then
        if ClienteConRecargo (QGrupoT.FieldByName('cod_empresa_fac_fc').AsString,
          ...
          raise Exception.Create('Factura con Recargo de equivalencia. Se generará manualmente');
  ...
  begin
    try
      ...
      CrearFichero;                              // Añadir Lineas (T, D, A, E) al fichero generado
