...
begin
  ...
  begin
    ...
    if Trim(DFactura.mtFacturas_Cab2.FieldByName('des_pais_fc').AsString) = 'ESPAÑA' then
    begin
...
begin
  ...
  begin
    ...
    begin
      if DFactura.mtFacturas_Cab2.FieldByName('des_pais_fc').AsString = 'ESPAÑA' then
...
begin
  ...
  begin
    ...
    if not (DFactura.mtFacturas_Cab2.FieldByName('des_pais_fc').AsString = 'ESPAÑA' ) then
    begin
    ...
    begin
      if (DFactura.mtFacturas_Cab2.FieldByName('des_pais_fc').AsString = 'ESPAÑA') then  qrmGarantia.Lines.Add(rggn.descri_esp+rGGN.ggn_code)
