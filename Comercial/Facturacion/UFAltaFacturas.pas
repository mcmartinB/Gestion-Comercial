...
begin
  ...
  begin
    ShowMessage( 'El código de la empresa a facturar es incorrecto.');
    edtEmpresa.SetFocus;
    exit;
  end;
  ...
  begin
    ShowMessage( 'El código del cliente a facturar es incorrecto.');
    edtcliente.SetFocus;
    exit;
  end;
    //Impuesto
  ...
  begin
    ShowMessage( 'El código del impuesto a facturar es incorrecto.');
  ...
  begin
    ShowMessage( 'El código de la moneda a facturar es incorrecto.');
    edtmoneda.SetFocus;
    exit;
  end;
    // Fecha Cambio
  ...
  begin
    ShowMessage('Al activar contador de Facturas Perdidas, se debe indicar un Número de Factura');
    txFactura.SetFocus;
    Exit;
  end;
...
begin
    ...
    begin
    if bAlta then
      sAux := 'La Factura / Abono Manual no se generará ¿Desea salir del mantenimiento?'
    else
      sAux := 'La Factura / Abono Manual no se modificará ¿Desea salir del mantenimiento?';
...
begin
  ...
  begin
    ShowMessage( 'El código de empresa albaran es incorrecto.');
    edtEmpAlbaran.SetFocus;
    exit;
  end;
    //Centro Salida
  ...
  begin
    ShowMessage( 'El número de albarán es incorrecto.');
  ...
  begin
    ShowMessage('La fecha de albarán es incorrecta');
...
//    ShowMessage('El producto del detalle es incorrecto.');
  ...
  begin
    ShowMessage('El artículo del detalle es incorrecto.');
    edtEnvase.SetFocus;
    exit;
  end;
    //Categoria
...
begin
  ...
  begin
    ShowMessage('Albarán incorrecto (empresa albarán - centro salida - número albarán - fecha albarán ).');
    edtCenSalida.SetFocus;
    Exit;
  end;
...
begin
  ...
  begin
    ...
    begin
      ShowError('El número de factura / abono indicado en el contador de facturas perdidas ya existe.');
      Result := false;
      exit;
    end;
    ...
    begin
      ShowError('El número de factura / abono indicado en el contador de facturas perdidas es incorrecto. ');
      Result := false;
      exit;
    end;
